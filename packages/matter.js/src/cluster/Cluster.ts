...
export type ResponseType<T extends Command<any, any, any>> =
    T extends OptionalCommand<any, infer ResponseT, any> ? ResponseT
    : T extends Command<any, infer ResponseT, any> ? ResponseT
    : never;
export type RequestType<T extends Command<any, any, any>> =
    T extends OptionalCommand<infer RequestT, any, any> ? RequestT
    : T extends Command<infer RequestT, any, any> ? RequestT
    : never;
...
export type EventType<T extends Event<any, any>> =
    T extends OptionalEvent<infer EventT, any> ? EventT
    : T extends Event<infer EventT, any> ? EventT
    : never;
