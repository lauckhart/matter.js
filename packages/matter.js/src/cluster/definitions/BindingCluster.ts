...
export namespace BindingCluster {
     ...
     * Binding
     *
     * The Binding Cluster is meant to replace the support from the Zigbee
     * Device Object (ZDO) for supporting the binding table.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `Binding.with()` and a list of supported
     * features.
     *
