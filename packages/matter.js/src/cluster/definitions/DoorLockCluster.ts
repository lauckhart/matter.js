...
/**
 * Standard DoorLock cluster properties.
 *
 * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2
 */
export const DoorLockMetadata = ClusterMetadata({
    id: 0x101,
    name: "DoorLock",
    revision: 1,
...
export const BaseComponent = ClusterComponent({
    attributes: {
         ...
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.3.28
         */
        defaultConfigurationRegister: OptionalAttribute(39, TlvDefaultConfigurationRegister, { readAcl: AccessLevel.View }),
...
export const DoorPositionSensorComponent = ClusterComponent({
    ...
    events: {
        /**
         * The door lock server sends out a DoorStateChange event when the door lock door state changes. The data of
         * this event SHALL contain the following information:
         *
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.5.2
         */
...
export type DoorLockCluster<T extends TypeFromPartialBitSchema<typeof DoorLockMetadata.features>> = 
    typeof DoorLockMetadata
    & { supportedFeatures: T }
...
export function DoorLockCluster<T extends (keyof typeof DoorLockMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...DoorLockMetadata,
        supportedFeatures: BitFlags(DoorLockMetadata.features, ...features),
        ...BaseComponent
    };
    ...
    return cluster as unknown as DoorLockCluster<BitFlags<typeof DoorLockMetadata.features, T>>;
};