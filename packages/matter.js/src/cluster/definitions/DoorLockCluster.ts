...
import { Cluster, Attribute, AccessLevel, OptionalAttribute, OptionalWritableAttribute, OptionalFixedAttribute, WritableAttribute, FixedAttribute, Command, TlvNoResponse, OptionalCommand, Event, EventPriority, OptionalEvent } from "../../cluster/Cluster.js";
import { BitFlag } from "../../schema/BitmapSchema.js";
import { TlvEnum, TlvUInt32, TlvUInt16, TlvUInt8, TlvBitmap, TlvUInt64 } from "../../tlv/TlvNumber.js";
...
export const KeypadOperationEventMask = TlvBitmap(TlvUInt16, {
    ...
    NonAccessUseroperationeventsourcekeypad: BitFlag(7)
});
...
export const ManualOperationEventMask = TlvBitmap(TlvUInt16, {
    ...
    Onetouchlock: BitFlag(3),
    KeyLock: BitFlag(4),
    KeyUnlock: BitFlag(5),
    Autolock: BitFlag(6),
    ScheduleLock: BitFlag(7),
    ScheduleUnlock: BitFlag(8),
    ManualLockKeyorThumbturn: BitFlag(9),
    ManualUnlockKeyorThumbturn: BitFlag(10)
});
...
/**
 * Event mask used to turn on and off RFID programming events. This mask DOES
 * NOT apply to the storing of events in the event log. This mask only applies
 * to the Programming Event Notification Command.
 *
 * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.3.46
 */
export const RfidProgrammingEventMask = TlvBitmap(TlvUInt16, {
    UnknownormanufacturerSpecifickeypadprogrammingevent: BitFlag(0),
    IdAddedSourceRfid: BitFlag(5),
    IDclearedSourceRfid: BitFlag(6)
});
...
export namespace DoorLockCluster {
     ...
     * support.  For type safety, use `DoorLock.with()` and a list of supported
     * features.
     *
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.3.4
             */
            doorState: OptionalAttribute(3, TlvNullable(TlvEnum<DoorState>()), { readAcl: AccessLevel.View }),
             ...
             */
            numberOfLogRecordsSupported: OptionalFixedAttribute(16, TlvUInt16, { readAcl: AccessLevel.View }),
             ...
             */
            numberOfTotalUsersSupported: OptionalFixedAttribute(17, TlvUInt16, { readAcl: AccessLevel.View }),
             ...
             */
            numberOfPinUsersSupported: OptionalFixedAttribute(18, TlvUInt16, { readAcl: AccessLevel.View }),
             ...
             */
            numberOfRfidUsersSupported: OptionalFixedAttribute(19, TlvUInt16, { readAcl: AccessLevel.View }),
             ...
             */
            numberOfWeekDaySchedulesSupportedPerUser: OptionalFixedAttribute(20, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            numberOfYearDaySchedulesSupportedPerUser: OptionalFixedAttribute(21, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            numberOfHolidaySchedulesSupported: OptionalFixedAttribute(22, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            maxPinCodeLength: OptionalFixedAttribute(23, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            minPinCodeLength: OptionalFixedAttribute(24, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            maxRfidCodeLength: OptionalFixedAttribute(25, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            minRfidCodeLength: OptionalFixedAttribute(26, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.3.19
             */
            credentialRulesSupport: OptionalFixedAttribute(27, CredentialRulesSupport, { default: 1, readAcl: AccessLevel.View }),
             ...
             */
            numberOfCredentialsSupportedPerUser: OptionalFixedAttribute(28, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            enableLogging: OptionalWritableAttribute(32, TlvBoolean, { default: true, readAcl: AccessLevel.View, writeAcl: AccessLevel.Administer }),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.3.23
             */
            operatingMode: WritableAttribute(37, TlvEnum<OperatingMode>(), { readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             */
            wrongCodeEntryLimit: OptionalWritableAttribute(48, TlvUInt8, { readAcl: AccessLevel.View, writeAcl: AccessLevel.Administer }),
             ...
             */
            userCodeTemporaryDisableTime: OptionalWritableAttribute(49, TlvUInt8, { readAcl: AccessLevel.View, writeAcl: AccessLevel.Administer }),
             ...
             */
            requirePiNforRemoteOperation: OptionalWritableAttribute(51, TlvBoolean, { default: true, readAcl: AccessLevel.View, writeAcl: AccessLevel.Administer }),
            ...
            /**
             * Event mask used to turn on and off RFID programming events. This
             * mask DOES NOT apply to the storing of events in the event log.
             * This mask only applies to the Programming Event Notification
             * Command.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.3.46
             */
            rfidProgrammingEventMask: OptionalWritableAttribute(71, RfidProgrammingEventMask, { default: 65535, readAcl: AccessLevel.View, writeAcl: AccessLevel.Administer })
        },
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            toggle: OptionalCommand(2, TlvNoArguments, 2, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getLogRecord: OptionalCommand(4, TlvNoArguments, 4, TlvNoArguments),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getLogRecordResponse: OptionalCommand(4, TlvNoArguments, 4, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setPinCode: OptionalCommand(5, TlvNoArguments, 5, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getPinCode: OptionalCommand(6, TlvNoArguments, 6, TlvNoArguments),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getPinCodeResponse: OptionalCommand(6, TlvNoArguments, 6, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearPinCode: OptionalCommand(7, TlvNoArguments, 7, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearAllPinCodes: OptionalCommand(8, TlvNoArguments, 8, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getUserStatusResponse: OptionalCommand(10, TlvNoArguments, 10, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setWeekDaySchedule: OptionalCommand(11, SetWeekDayScheduleRequest, 11, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getWeekDaySchedule: OptionalCommand(12, GetWeekDayScheduleRequest, 12, GetWeekDayScheduleResponseRequest),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getWeekDayScheduleResponse: OptionalCommand(12, GetWeekDayScheduleResponseRequest, 12, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearWeekDaySchedule: OptionalCommand(13, ClearWeekDayScheduleRequest, 13, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setYearDaySchedule: OptionalCommand(14, SetYearDayScheduleRequest, 14, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getYearDaySchedule: OptionalCommand(15, GetYearDayScheduleRequest, 15, GetYearDayScheduleResponseRequest),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getYearDayScheduleResponse: OptionalCommand(15, GetYearDayScheduleResponseRequest, 15, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearYearDaySchedule: OptionalCommand(16, ClearYearDayScheduleRequest, 16, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setHolidaySchedule: OptionalCommand(17, SetHolidayScheduleRequest, 17, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getHolidaySchedule: OptionalCommand(18, GetHolidayScheduleRequest, 18, GetHolidayScheduleResponseRequest),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getHolidayScheduleResponse: OptionalCommand(18, GetHolidayScheduleResponseRequest, 18, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearHolidaySchedule: OptionalCommand(19, ClearHolidayScheduleRequest, 19, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getUserTypeResponse: OptionalCommand(21, TlvNoArguments, 21, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setRfidCode: OptionalCommand(22, TlvNoArguments, 22, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getRfidCode: OptionalCommand(23, TlvNoArguments, 23, TlvNoArguments),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getRfidCodeResponse: OptionalCommand(23, TlvNoArguments, 23, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearRfidCode: OptionalCommand(24, TlvNoArguments, 24, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearAllRfidCodes: OptionalCommand(25, TlvNoArguments, 25, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setUser: OptionalCommand(26, SetUserRequest, 26, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getUser: OptionalCommand(27, GetUserRequest, 28, GetUserResponseRequest),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getUserResponse: OptionalCommand(28, GetUserResponseRequest, 28, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearUser: OptionalCommand(29, ClearUserRequest, 29, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setCredential: OptionalCommand(34, SetCredentialRequest, 35, SetCredentialResponseRequest),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            setCredentialResponse: OptionalCommand(35, SetCredentialResponseRequest, 35, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getCredentialStatus: OptionalCommand(36, GetCredentialStatusRequest, 37, GetCredentialStatusResponseRequest),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            getCredentialStatusResponse: OptionalCommand(37, GetCredentialStatusResponseRequest, 37, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.4
             */
            clearCredential: OptionalCommand(38, ClearCredentialRequest, 38, TlvNoResponse)
        },
        ...
        events: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.5.2
             */
            doorStateChange: OptionalEvent(1, EventPriority.Critical, DoorStateChangeEvent),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 5.2.5.5
             */
            lockUserChange: OptionalEvent(4, EventPriority.Info, LockUserChangeEvent)
        }
    });
};