...
import { Cluster, OptionalAttribute, AccessLevel, OptionalCommand, TlvNoResponse, Command } from "../../cluster/Cluster.js";
...
export namespace ChannelCluster {
     ...
     * support.  For type safety, use `Channel.with()` and a list of supported
     * features.
     *
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            channelList: OptionalAttribute(0, TlvArray(ChannelInfoStruct), { readAcl: AccessLevel.View }),
             ...
             */
            lineup: OptionalAttribute(1, TlvNullable(LineupInfoStruct), { default: null, readAcl: AccessLevel.View }),
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.6.4.1
             */
            changeChannel: OptionalCommand(0, ChangeChannelRequest, 1, ChangeChannelResponseRequest),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.6.4.2
             */
            changeChannelResponse: OptionalCommand(1, ChangeChannelResponseRequest, 1, TlvNoResponse),
