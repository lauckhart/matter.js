...
export namespace AccountLoginCluster {
     ...
     * Player device, which is represented as an endpoint (see [TV
     * Architecture]), can use this cluster to help make the user account on
     * the Content App match the user account on the Client.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `AccountLogin.with()` and a list of
     * supported features.
     *
