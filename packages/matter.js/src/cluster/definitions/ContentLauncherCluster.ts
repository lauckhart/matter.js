...
import { Cluster, OptionalAttribute, AccessLevel, OptionalWritableAttribute, OptionalCommand, TlvNoResponse } from "../../cluster/Cluster.js";
import { BitFlag } from "../../schema/BitmapSchema.js";
import { TlvArray } from "../../tlv/TlvArray.js";
import { TlvString, TlvByteString } from "../../tlv/TlvString.js";
import { TlvBitmap, TlvUInt32, TlvEnum, TlvDouble } from "../../tlv/TlvNumber.js";
 ...
 */
export const SupportedStreamingProtocols = TlvBitmap(TlvUInt32, {});
...
export namespace ContentLauncherCluster {
     ...
     * Content Launcher
     *
     * This cluster provides an interface for launching content on a media
     * player device such as a TV or Speaker.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `ContentLauncher.with()` and a list of
     * supported features.
     *
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            acceptHeader: OptionalAttribute(0, TlvArray(TlvString), { persistent: true, readAcl: AccessLevel.View }),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.7.3.2
             */
            supportedStreamingProtocols: OptionalWritableAttribute(1, SupportedStreamingProtocols, { persistent: true })
        },
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.7.4.1
             */
            launchContent: OptionalCommand(0, LaunchContentRequest, 2, LauncherResponseRequest),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.7.4.2
             */
            launchUrl: OptionalCommand(1, LaunchUrlRequest, 2, LauncherResponseRequest),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.7.4.3
             */
            launcherResponse: OptionalCommand(2, LauncherResponseRequest, 2, TlvNoResponse)
        }
    });
};