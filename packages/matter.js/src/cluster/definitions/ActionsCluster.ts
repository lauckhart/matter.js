...
import { Cluster, Attribute, AccessLevel, OptionalAttribute, OptionalCommand, TlvNoResponse, Event, EventPriority } from "../../cluster/Cluster.js";
...
export namespace ActionsCluster {
     ...
     * Actions
     *
     * This cluster provides a standardized way for a Node (typically a Bridge,
     * but could be any Node) to expose action information.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `Actions.with()` and a list of supported
     * features.
     *
