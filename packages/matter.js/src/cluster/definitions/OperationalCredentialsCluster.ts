...
import { Cluster, Attribute, AccessLevel, FabricScopedAttribute, FixedAttribute, Command, TlvNoResponse } from "../../cluster/Cluster.js";
...
export namespace OperationalCredentialsCluster {
     ...
     *
     * This cluster is used to add or remove Operational Credentials on a
     * Commissionee or Node, as well as manage the associated Fabrics.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `OperationalCredentials.with()` and a
