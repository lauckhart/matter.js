...
/**
 * Standard PumpConfigurationAndControl cluster properties.
 *
 * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.2
 */
export const PumpConfigurationAndControlMetadata = ClusterMetadata({
    id: 0x200,
...
/**
 * A PumpConfigurationAndControlCluster supports these elements for all feature combinations.
 */
export const BaseComponent = ClusterComponent({
    attributes: {
         ...
         */
        effectiveControlMode: Attribute(18, TlvEnum<TlvControlModeEnum>(), { persistent: true, readAcl: AccessLevel.View }),
...
export type PumpConfigurationAndControlCluster<T extends TypeFromPartialBitSchema<typeof PumpConfigurationAndControlMetadata.features>> = 
    typeof PumpConfigurationAndControlMetadata
    & { supportedFeatures: T }
    & typeof BaseComponent
    & (T extends { constantPressure: true } ? typeof ConstantPressureComponent : {})
    & (T extends { automatic: true } ? typeof AutomaticComponent : {})
    & (T extends { compensatedPressure: true } ? typeof CompensatedPressureComponent : {})
    & (T extends { constantSpeed: true } ? typeof ConstantSpeedComponent : {})
    & (T extends { constantFlow: true } ? typeof ConstantFlowComponent : {})
    & (T extends { constantTemperature: true } ? typeof ConstantTemperatureComponent : {});

export function PumpConfigurationAndControlCluster<T extends (keyof typeof PumpConfigurationAndControlMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...PumpConfigurationAndControlMetadata,
        supportedFeatures: BitFlags(PumpConfigurationAndControlMetadata.features, ...features),
        ...BaseComponent
    };
    ...
    return cluster as unknown as PumpConfigurationAndControlCluster<BitFlags<typeof PumpConfigurationAndControlMetadata.features, T>>;
};