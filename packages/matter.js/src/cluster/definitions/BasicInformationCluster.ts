...
/**
 * Standard BasicInformation cluster properties.
 *
 * @see {@link MatterCoreSpecificationV1_1} § 11.1
 */
export const BasicInformationMetadata = ClusterMetadata({ id: 0x28, name: "BasicInformation", revision: 1 });
...
export type BasicInformationCluster<T extends TypeFromPartialBitSchema<typeof BasicInformationMetadata.features>> = 
    typeof BasicInformationMetadata
    & { supportedFeatures: T }
    & typeof BaseComponent;

export function BasicInformationCluster<T extends (keyof typeof BasicInformationMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...BasicInformationMetadata,
        supportedFeatures: BitFlags(BasicInformationMetadata.features, ...features),
        ...BaseComponent
    };
    
    return cluster as unknown as BasicInformationCluster<BitFlags<typeof BasicInformationMetadata.features, T>>;
};