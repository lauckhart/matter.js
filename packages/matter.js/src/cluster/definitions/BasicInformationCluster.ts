...
import { Cluster, FixedAttribute, AccessLevel, WritableAttribute, OptionalFixedAttribute, OptionalWritableAttribute, OptionalAttribute, Event, EventPriority, OptionalEvent } from "../../cluster/Cluster.js";
...
export namespace BasicInformationCluster {
     ...
     * Basic Information
     *
     * This cluster provides attributes and events for determining basic
     * information about Nodes, which supports both Commissioning and
     * operational determination of Node characteristics, such as Vendor ID,
     * Product ID and serial number, which apply to the whole Node. Also allows
     * setting user device information such as location.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `BasicInformation.with()` and a list of
     * supported features.
     *
