...
/**
 * Standard OccupancySensing cluster properties.
 *
 * @see {@link MatterApplicationClusterSpecificationV1_1} § 2.7
 */
export const OccupancySensingMetadata = ClusterMetadata({ id: 0x406, name: "OccupancySensing", revision: 1 });
...
export type OccupancySensingCluster<T extends TypeFromPartialBitSchema<typeof OccupancySensingMetadata.features>> = 
    typeof OccupancySensingMetadata
    & { supportedFeatures: T }
    & typeof BaseComponent;

export function OccupancySensingCluster<T extends (keyof typeof OccupancySensingMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...OccupancySensingMetadata,
        supportedFeatures: BitFlags(OccupancySensingMetadata.features, ...features),
        ...BaseComponent
    };
    
    return cluster as unknown as OccupancySensingCluster<BitFlags<typeof OccupancySensingMetadata.features, T>>;
};