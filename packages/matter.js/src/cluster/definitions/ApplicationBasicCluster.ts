...
import { Cluster, OptionalFixedAttribute, AccessLevel, FixedAttribute, Attribute } from "../../cluster/Cluster.js";
...
export namespace ApplicationBasicCluster {
     ...
     * Application Basic
     *
     * This cluster provides information about an application running on a TV
     * or media player device which is represented as an endpoint.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `ApplicationBasic.with()` and a list of
     * supported features.
     *
