...
import { Cluster, Attribute, AccessLevel, FixedAttribute, OptionalAttribute, OptionalFixedAttribute, OptionalEvent, EventPriority } from "../../cluster/Cluster.js";
...
export namespace PowerSourceCluster {
     ...
     * physical power source that provides power to the Node.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `PowerSource.with()` and a list of
     * supported features.
     *
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            wiredCurrentType: OptionalFixedAttribute(5, TlvEnum<WiredCurrentTypeEnum>(), { readAcl: AccessLevel.View }),
             ...
             */
            batChargeLevel: OptionalAttribute(14, TlvEnum<BatChargeLevelEnum>(), { readAcl: AccessLevel.View }),
             ...
             */
            batReplacementNeeded: OptionalAttribute(15, TlvBoolean, { readAcl: AccessLevel.View }),
             ...
             */
            batReplaceability: OptionalFixedAttribute(16, TlvEnum<BatReplaceabilityEnum>(), { readAcl: AccessLevel.View }),
             ...
             */
            batReplacementDescription: OptionalFixedAttribute(19, TlvString.bound({ maxLength: 60 }), { readAcl: AccessLevel.View }),
             ...
             */
            batQuantity: OptionalFixedAttribute(25, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            batChargeState: OptionalAttribute(26, TlvEnum<BatChargeStateEnum>(), { readAcl: AccessLevel.View }),
             ...
             */
            batFunctionalWhileCharging: OptionalAttribute(28, TlvBoolean, { readAcl: AccessLevel.View }),
