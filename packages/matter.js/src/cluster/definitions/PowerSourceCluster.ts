...
/**
 * Standard PowerSource cluster properties.
 *
 * @see {@link MatterCoreSpecificationV1_1} § 11.7
 */
export const PowerSourceMetadata = ClusterMetadata({
    id: 0x2f,
    name: "PowerSource",
    revision: 1,
...
export type PowerSourceCluster<T extends TypeFromPartialBitSchema<typeof PowerSourceMetadata.features>> = 
    typeof PowerSourceMetadata
    & { supportedFeatures: T }
...
export function PowerSourceCluster<T extends (keyof typeof PowerSourceMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...PowerSourceMetadata,
        supportedFeatures: BitFlags(PowerSourceMetadata.features, ...features),
        ...BaseComponent
    };
    ...
    return cluster as unknown as PowerSourceCluster<BitFlags<typeof PowerSourceMetadata.features, T>>;
};