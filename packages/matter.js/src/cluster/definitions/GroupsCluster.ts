...
import { Cluster, FixedAttribute, AccessLevel, Command, TlvNoResponse } from "../../cluster/Cluster.js";
...
export namespace GroupsCluster {
     ...
     * support.  For type safety, use `Groups.with()` and a list of supported
     * features.
     *
