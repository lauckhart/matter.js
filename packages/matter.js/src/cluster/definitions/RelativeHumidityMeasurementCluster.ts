...
export namespace RelativeHumidityMeasurementCluster {
     ...
     *
     * Attributes and commands for configuring the measurement of relative
     * humidity, and reporting relative humidity measurements.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `RelativeHumidityMeasurement.with()` and
