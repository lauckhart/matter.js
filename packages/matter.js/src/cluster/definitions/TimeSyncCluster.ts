...
import { Cluster, Attribute, AccessLevel, OptionalAttribute, WritableAttribute, OptionalWritableAttribute, OptionalFixedAttribute, Command, TlvNoResponse, OptionalEvent, EventPriority } from "../../cluster/Cluster.js";
...
export namespace TimeSyncCluster {
     ...
     * display and validating security materials.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `TimeSync.with()` and a list of supported
     * features.
     *
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            defaultNtp: OptionalWritableAttribute(4, TlvNullable(TlvString.bound({ maxLength: 128 })), { default: null, readAcl: AccessLevel.View, writeAcl: AccessLevel.Administer }),
             ...
             */
            timeZone: OptionalWritableAttribute(5, TlvArray(TimeZoneStruct), { readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             */
            dstOffset: OptionalWritableAttribute(6, TlvArray(DSTOffsetStruct), { readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             */
            localTime: OptionalAttribute(7, TlvNullable(TlvUInt64), { omitChanges: true, readAcl: AccessLevel.View }),
             ...
             */
            timeZoneDatabase: OptionalFixedAttribute(8, TlvBoolean, { default: true, readAcl: AccessLevel.View }),
             ...
             */
            ntpServerPort: OptionalAttribute(9, TlvNullable(TlvUInt16), { default: null, readAcl: AccessLevel.View })
        },
        ...
        events: {
             ...
             */
            dstTableEmpty: OptionalEvent(0, EventPriority.Info, TlvNoArguments),
             ...
             */
            dstStatus: OptionalEvent(1, EventPriority.Info, TlvNoArguments),
             ...
             * @see {@link MatterCoreSpecificationV1_1} § 11.16.10.3
             */
            timeZoneStatus: OptionalEvent(2, EventPriority.Info, TimeZoneStatusEvent)
        }
    });
};