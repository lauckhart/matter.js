...
/**
 * Standard TimeSync cluster properties.
 *
 * @see {@link MatterCoreSpecificationV1_1} § 11.16
 */
export const TimeSyncMetadata = ClusterMetadata({
    id: 0x38,
    name: "TimeSync",
    revision: 1,
...
export type TimeSyncCluster<T extends TypeFromPartialBitSchema<typeof TimeSyncMetadata.features>> = 
    typeof TimeSyncMetadata
    & { supportedFeatures: T }
...
export function TimeSyncCluster<T extends (keyof typeof TimeSyncMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...TimeSyncMetadata,
        supportedFeatures: BitFlags(TimeSyncMetadata.features, ...features),
        ...BaseComponent
    };
    ...
    return cluster as unknown as TimeSyncCluster<BitFlags<typeof TimeSyncMetadata.features, T>>;
};