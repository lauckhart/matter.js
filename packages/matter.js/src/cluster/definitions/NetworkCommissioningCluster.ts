...
export namespace NetworkCommissioningCluster {
    ...
    export const Complete = BuildCluster({
        ...
        revision,
        features: featureMap,
        supportedFeatures: { wiFiNetworkInterface: true, threadNetworkInterface: true, ethernetNetworkInterface: true },
        elements: [ Base, WiFiNetworkInterfaceOrThreadNetworkInterface, WiFiNetworkInterface, ThreadNetworkInterface ]
    });
};