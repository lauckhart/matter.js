...
export namespace ThermostatUserInterfaceConfigurationCluster {
     ...
     *
     * An interface for configuring the user interface of a thermostat (which
     * may be remote from the thermostat).
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use
     * `ThermostatUserInterfaceConfiguration.with()` and a list of supported
     * features.
     *
