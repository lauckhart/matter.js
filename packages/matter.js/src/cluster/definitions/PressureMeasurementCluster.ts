...
export namespace PressureMeasurementCluster {
     ...
     *
     * Attributes and commands for configuring the measurement of pressure, and
     * reporting pressure measurements.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `PressureMeasurement.with()` and a list
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            scaledValue: OptionalAttribute(16, TlvNullable(TlvInt16), { readAcl: AccessLevel.View }),
             ...
             */
            minScaledValue: OptionalAttribute(17, TlvNullable(TlvInt16), { readAcl: AccessLevel.View }),
             ...
             */
            maxScaledValue: OptionalAttribute(18, TlvNullable(TlvInt16), { readAcl: AccessLevel.View }),
             ...
             */
            scale: OptionalAttribute(20, TlvInt8, { readAcl: AccessLevel.View })
        }
    });
};