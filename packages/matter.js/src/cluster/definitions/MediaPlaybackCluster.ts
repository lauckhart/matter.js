...
/**
 * Standard MediaPlayback cluster properties.
 *
 * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10
 */
export const MediaPlaybackMetadata = ClusterMetadata({
    id: 0x506,
    name: "MediaPlayback",
    revision: 1,
...
export const BaseComponent = ClusterComponent({
    ...
    commands: {
        ...
        /**
         * Upon receipt, this SHALL Skip forward in the media by the given number of milliseconds, using the data as
         * follows:
         *
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.9
         */
        ...
        /**
         * Upon receipt, this SHALL Skip backward in the media by the given number of milliseconds, using the data as
         * follows:
         *
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.10
         */
        ...
        /**
         * This command SHALL be generated in response to various Playback Commands. The data for this command SHALL be
         * as follows:
         *
         * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.12
         */
...
export const AdvancedSeekComponent = ClusterComponent({
    attributes: {
         ...
         */
        sampledPosition: Attribute(3, TlvNullable(TlvPlaybackPositionStruct), { default: null, readAcl: AccessLevel.View }),
...
export type MediaPlaybackCluster<T extends TypeFromPartialBitSchema<typeof MediaPlaybackMetadata.features>> = 
    typeof MediaPlaybackMetadata
    & { supportedFeatures: T }
    & typeof BaseComponent
    & (T extends { advancedSeek: true } ? typeof AdvancedSeekComponent : {})
    & (T extends { variableSpeed: true } ? typeof VariableSpeedComponent : {});

export function MediaPlaybackCluster<T extends (keyof typeof MediaPlaybackMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...MediaPlaybackMetadata,
        supportedFeatures: BitFlags(MediaPlaybackMetadata.features, ...features),
        ...BaseComponent
    };
    ...
    return cluster as unknown as MediaPlaybackCluster<BitFlags<typeof MediaPlaybackMetadata.features, T>>;
};