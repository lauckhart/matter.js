...
import { Cluster, Attribute, AccessLevel, OptionalAttribute, Command, OptionalCommand, TlvNoResponse } from "../../cluster/Cluster.js";
import { BitFlag } from "../../schema/BitmapSchema.js";
import { TlvEnum, TlvUInt64, TlvSingle } from "../../tlv/TlvNumber.js";
...
export namespace MediaPlaybackCluster {
     ...
     * PAUSE, etc) on a media device such as a TV or Speaker.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `MediaPlayback.with()` and a list of
     * supported features.
     *
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            startTime: OptionalAttribute(1, TlvNullable(TlvUInt64), { readAcl: AccessLevel.View }),
             ...
             */
            duration: OptionalAttribute(2, TlvNullable(TlvUInt64), { readAcl: AccessLevel.View }),
             ...
             */
            sampledPosition: OptionalAttribute(3, TlvNullable(PlaybackPositionStruct), { default: null, readAcl: AccessLevel.View }),
             ...
             */
            playbackSpeed: OptionalAttribute(4, TlvSingle, { readAcl: AccessLevel.View }),
             ...
             */
            seekRangeEnd: OptionalAttribute(5, TlvNullable(TlvUInt64), { default: null, readAcl: AccessLevel.View }),
             ...
             */
            seekRangeStart: OptionalAttribute(6, TlvNullable(TlvUInt64), { default: null, readAcl: AccessLevel.View })
        },
        ...
        commands: {
             ...
             */
            rewind: OptionalCommand(6, TlvNoArguments, 10, PlaybackResponseRequest),
             ...
             */
            fastForward: OptionalCommand(7, TlvNoArguments, 10, PlaybackResponseRequest),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 6.10.4.11
             */
            seek: OptionalCommand(11, SeekRequest, 10, PlaybackResponseRequest)
        }
    });
};