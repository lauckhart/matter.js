...
export namespace ThreadNetworkDiagnosticsCluster {
    ...
    const Base = {
        attributes: {
             ...
             */
            neighborTable: Attribute(7, TlvArray(TlvNeighborTableStruct), { readAcl: AccessLevel.View }),
             ...
             */
            routeTable: Attribute(8, TlvArray(TlvRouteTableStruct), { readAcl: AccessLevel.View }),
             ...
             */
            activeNetworkFaults: Attribute(62, TlvArray(TlvEnum<TlvNetworkFaultEnum>()), { readAcl: AccessLevel.View })
        },
    ...
    export const Complete = BuildCluster({
        ...
        revision,
        features: featureMap,
        supportedFeatures: { packetCounts: true, errorCounts: true, mleCounts: true, macCounts: true },
        elements: [ Base, ErrorCounts, MleCounts, MacCounts ]
    });
};