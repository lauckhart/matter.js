...
/**
 * Standard ThreadNetworkDiagnostics cluster properties.
 *
 * @see {@link MatterCoreSpecificationV1_1} § 11.13
 */
export const ThreadNetworkDiagnosticsMetadata = ClusterMetadata({
    id: 0x35,
...
export type ThreadNetworkDiagnosticsCluster<T extends TypeFromPartialBitSchema<typeof ThreadNetworkDiagnosticsMetadata.features>> = 
    typeof ThreadNetworkDiagnosticsMetadata
    & { supportedFeatures: T }
...
export function ThreadNetworkDiagnosticsCluster<T extends (keyof typeof ThreadNetworkDiagnosticsMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...ThreadNetworkDiagnosticsMetadata,
        supportedFeatures: BitFlags(ThreadNetworkDiagnosticsMetadata.features, ...features),
        ...BaseComponent
    };
    ...
    return cluster as unknown as ThreadNetworkDiagnosticsCluster<BitFlags<typeof ThreadNetworkDiagnosticsMetadata.features, T>>;
};