 ...
 * sensor. This attribute shall be set to one of the non-reserved values listed
 * in Values of the LightSensorType Attribute.
 *
...
export const enum LightSensorType {
    Photodiode = 0,
    Cmos = 1,
    ReservedForManufacturerSpecificLightSensorTypes = 64
};
...
export namespace IlluminanceMeasurementCluster {
     ...
     * support.  For type safety, use `IlluminanceMeasurement.with()` and a
    ...
    export const Complete = Cluster({
        ...
        attributes: {
            /**
             * The MeasuredValue attribute represents the illuminance in Lux
             * (symbol lx) as follows:
             *
             ...
             * MeasuredValue that can be measured. A value of null indicates
             * that this attribute is not defined. See Measured Value for more
             * details.
             *
             ...
             * the light sensor. This attribute shall be set to one of the
             * non-reserved values listed in Values of the LightSensorType
             * Attribute.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 2.2.5.5
             */
            lightSensorType: OptionalAttribute(4, TlvNullable(TlvEnum<LightSensorType>()), { default: 255, readAcl: AccessLevel.View })
        }
    });
};