...
import { Cluster, Attribute, AccessLevel, OptionalAttribute, Command, TlvNoResponse, OptionalCommand } from "../../cluster/Cluster.js";
import { BitFlag } from "../../schema/BitmapSchema.js";
import { TlvUInt8, TlvUInt16, TlvBitmap, TlvUInt64, TlvEnum, TlvUInt32 } from "../../tlv/TlvNumber.js";
...
/**
 * The Status field contains the status of the copy scene attempt. This field
 * SHALL be set to one of the non-reserved values listed in Values of the
 * Status Field of the CopySceneResponse Command.
 *
 ...
 */
export const Mode = TlvBitmap(TlvUInt8, { CopyAllScenes: BitFlag(1) });
...
export namespace ScenesCluster {
     ...
     * support.  For type safety, use `Scenes.with()` and a list of supported
     * features.
     *
