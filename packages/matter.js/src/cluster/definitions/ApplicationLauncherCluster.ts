...
import { Cluster, OptionalAttribute, AccessLevel, OptionalWritableAttribute, Command, TlvNoResponse } from "../../cluster/Cluster.js";
...
export namespace ApplicationLauncherCluster {
     ...
     * support.  For type safety, use `ApplicationLauncher.with()` and a list
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            catalogList: OptionalAttribute(0, TlvArray(TlvUInt16), { persistent: true, readAcl: AccessLevel.View }),
