...
/**
 * Standard EthernetNetworkDiagnostics cluster properties.
 *
 * @see {@link MatterCoreSpecificationV1_1} § 11.15
 */
export const EthernetNetworkDiagnosticsMetadata = ClusterMetadata({
    id: 0x37,
...
export const BaseComponent = ClusterComponent({
    attributes: {
         ...
         */
        phyRate: OptionalAttribute(0, TlvNullable(TlvEnum<TlvPHYRateEnum>()), { default: null, readAcl: AccessLevel.View }),
...
export type EthernetNetworkDiagnosticsCluster<T extends TypeFromPartialBitSchema<typeof EthernetNetworkDiagnosticsMetadata.features>> = 
    typeof EthernetNetworkDiagnosticsMetadata
    & { supportedFeatures: T }
...
export function EthernetNetworkDiagnosticsCluster<T extends (keyof typeof EthernetNetworkDiagnosticsMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...EthernetNetworkDiagnosticsMetadata,
        supportedFeatures: BitFlags(EthernetNetworkDiagnosticsMetadata.features, ...features),
        ...BaseComponent
    };
    ...
    return cluster as unknown as EthernetNetworkDiagnosticsCluster<BitFlags<typeof EthernetNetworkDiagnosticsMetadata.features, T>>;
};