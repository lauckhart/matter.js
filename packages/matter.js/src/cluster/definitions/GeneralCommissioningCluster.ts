...
import { Cluster, WritableAttribute, AccessLevel, FixedAttribute, Attribute, Command, TlvNoResponse } from "../../cluster/Cluster.js";
...
export namespace GeneralCommissioningCluster {
     ...
     * support.  For type safety, use `GeneralCommissioning.with()` and a list
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             */
            regulatoryConfig: Attribute(2, TlvEnum<RegulatoryLocationTypeEnum>(), { default: { reference: "LocationCapability" }, readAcl: AccessLevel.View }),
