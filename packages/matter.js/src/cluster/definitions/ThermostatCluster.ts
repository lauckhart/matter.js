...
import { Cluster, Attribute, AccessLevel, OptionalAttribute, OptionalFixedAttribute, OptionalWritableAttribute, WritableAttribute, Command, TlvNoResponse, OptionalCommand } from "../../cluster/Cluster.js";
import { BitFlag } from "../../schema/BitmapSchema.js";
import { TlvInt16, TlvBitmap, TlvUInt8, TlvInt8, TlvEnum, TlvUInt16, TlvUInt32 } from "../../tlv/TlvNumber.js";
...
export const AlarmMask = TlvBitmap(TlvUInt8, {
    InitializationfailureThedevicefailedtocompleteinitializationatpowerUp: BitFlag(0),
...
export namespace ThermostatCluster {
     ...
     * Thermostat
     *
     * An interface for configuring and controlling the functionality of a
     * thermostat.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `Thermostat.with()` and a list of
     * supported features.
     *
    ...
    export const Complete = Cluster({
        ...
        attributes: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.3.7.4
             */
            occupancy: OptionalAttribute(2, Occupancy, { default: 1, readAcl: AccessLevel.View }),
             ...
             */
            occupiedCoolingSetpoint: OptionalWritableAttribute(17, TlvInt16, { scene: true, persistent: true, default: 2600 }),
             ...
             */
            occupiedHeatingSetpoint: OptionalWritableAttribute(18, TlvInt16, { scene: true, persistent: true, default: 2000 }),
             ...
             */
            minSetpointDeadBand: OptionalWritableAttribute(25, TlvInt8, { persistent: true, default: 25, readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.3.7.27
             */
            startOfWeek: OptionalFixedAttribute(32, TlvEnum<StartOfWeek>(), { readAcl: AccessLevel.View }),
             ...
             */
            numberOfWeeklyTransitions: OptionalFixedAttribute(33, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            numberOfDailyTransitions: OptionalFixedAttribute(34, TlvUInt8, { readAcl: AccessLevel.View }),
             ...
             */
            temperatureSetpointHoldDuration: OptionalWritableAttribute(36, TlvNullable(TlvUInt16), { persistent: true, default: 65535, readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             */
            occupiedSetback: OptionalWritableAttribute(52, TlvNullable(TlvUInt8), { persistent: true, default: null, readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             */
            occupiedSetbackMin: OptionalFixedAttribute(53, TlvNullable(TlvUInt8), { default: null, readAcl: AccessLevel.View }),
             ...
             */
            occupiedSetbackMax: OptionalFixedAttribute(54, TlvNullable(TlvUInt8), { default: null, readAcl: AccessLevel.View }),
             ...
             */
            unoccupiedSetback: OptionalWritableAttribute(55, TlvNullable(TlvUInt8), { persistent: true, default: null, readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             */
            unoccupiedSetbackMin: OptionalFixedAttribute(56, TlvNullable(TlvUInt8), { default: null, readAcl: AccessLevel.View }),
             ...
             */
            unoccupiedSetbackMax: OptionalFixedAttribute(57, TlvNullable(TlvUInt8), { default: null, readAcl: AccessLevel.View }),
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.3.8
             */
            setWeeklySchedule: OptionalCommand(1, SetWeeklyScheduleRequest, 1, TlvNoResponse),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.3.8
             */
            getWeeklySchedule: OptionalCommand(2, GetWeeklyScheduleRequest, 0, GetWeeklyScheduleResponseRequest),

            /**
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.3.8
             */
            clearWeeklySchedule: OptionalCommand(3, TlvNoArguments, 3, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 4.3.8
             */
            getWeeklyScheduleResponse: OptionalCommand(0, GetWeeklyScheduleResponseRequest, 0, TlvNoResponse),
