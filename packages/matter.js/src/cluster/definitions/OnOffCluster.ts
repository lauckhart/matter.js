...
export namespace OnOffCluster {
    ...
    const LevelControlForLighting = {
        attributes: {
             ...
             */
            onTime: WritableAttribute(16385, TlvNullable(TlvUInt16)),
             ...
             */
            offWaitTime: WritableAttribute(16386, TlvNullable(TlvUInt16)),
             ...
             */
            startUpOnOff: WritableAttribute(16387, TlvNullable(TlvEnum<StartUpOnOffEnum>()), { persistent: true, readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage })
        },
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.5.7.4
             */
            offWithEffect: Command(64, OffWithEffectRequest, 64, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 1.5.7.6
             */
            onWithTimedOff: Command(66, OnWithTimedOffRequest, 66, TlvNoResponse)
        }
    };
