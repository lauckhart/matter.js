...
export const ElectricalMeasurementCluster = Cluster({
    ...
    attributes: {
        ...
        dcVoltageMultiplier: OptionalAttribute(0x200, TlvUInt16, { default: 1 }),
        dcVoltageDivisor: OptionalAttribute(0x201, TlvUInt16, { default: 1 }),
        dcCurrentMultiplier: OptionalAttribute(0x202, TlvUInt16, { default: 1 }),
        dcCurrentDivisor: OptionalAttribute(0x203, TlvUInt16, { default: 1 }),
        dcPowerMultiplier: OptionalAttribute(0x204, TlvUInt16, { default: 1 }),
        dcPowerDivisor: OptionalAttribute(0x205, TlvUInt16, { default: 1 }),
        ...
        totalApparentPower: OptionalAttribute(0x306, TlvUInt32, { default: 1 }),
        ...
        acFrequencyMultiplier: OptionalAttribute(0x400, TlvUInt16, { default: 1 }),
        acFrequencyDivisor: OptionalAttribute(0x401, TlvUInt16, { default: 1 }),
        powerMultiplier: OptionalAttribute(0x402, TlvUInt32, { default: 1 }),
        powerDivisor: OptionalAttribute(0x403, TlvUInt32, { default: 1 }),
        harmonicCurrentMultiplier: OptionalAttribute(0x404, TlvInt8, { default: 0 }),
        phaseHarmonicCurrentMultiplier: OptionalAttribute(0x405, TlvInt8, { default: 0 }),
        ...
        acPowerFactor: OptionalAttribute(0x510, TlvInt8, { default: 0 }),
        ...
        acVoltageMultiplier: OptionalAttribute(0x600, TlvUInt16, { default: 1 }),
        acVoltageDivisor: OptionalAttribute(0x601, TlvUInt16, { default: 1 }),
        acCurrentMultiplier: OptionalAttribute(0x602, TlvUInt16, { default: 1 }),
        acCurrentDivisor: OptionalAttribute(0x603, TlvUInt16, { default: 1 }),
        acPowerMultiplier: OptionalAttribute(0x604, TlvUInt16, { default: 1 }),
        acPowerDivisor: OptionalAttribute(0x605, TlvUInt16, { default: 1 }),
        ...
        powerFactorPhaseB: OptionalAttribute(0x910, TlvInt8, { default: 0 }),
        ...
        powerFactorPhaseC: OptionalAttribute(0xa10, TlvInt8, { default: 0 }),
