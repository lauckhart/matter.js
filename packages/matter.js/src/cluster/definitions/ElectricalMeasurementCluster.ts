...
import { TlvBitmap, TlvUInt32, TlvInt16, TlvUInt16, TlvInt32, TlvInt8, TlvUInt8, TlvEnum } from "../../tlv/TlvNumber.js";
import { BitFlag } from "../../schema/BitmapSchema.js";
import { TlvObject, TlvField } from "../../tlv/TlvObject.js";
import { TlvNoArguments } from "../../tlv/TlvNoArguments.js";

export const MeasurementType = TlvBitmap(TlvUInt32, {});

export const DcOverloadAlarmsMask = TlvBitmap(TlvUInt8, {});

export const AcOverloadAlarmsMask = TlvBitmap(TlvUInt16, {});

export const enum ProfileIntervalPeriod {};

export const GetProfileInfoResponseCommandRequest = TlvObject({
    ProfileCount: TlvField(0, TlvUInt8),
    ProfileIntervalPeriod: TlvField(1, TlvEnum<ProfileIntervalPeriod>()),
...
export namespace ElectricalMeasurementCluster {
     ...
     *
     * Attributes related to the electrical properties of a device. This
     * cluster is used by power outlets and other devices that need to provide
     * instantaneous data as opposed to metrology data which should be
     * retrieved from the metering cluster..
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `ElectricalMeasurement.with()` and a list
    ...
    export const Complete = Cluster({
        ...
        attributes: {
            measurementType: OptionalAttribute(0, MeasurementType),
            ...
            dcOverloadAlarmsMask: OptionalWritableAttribute(1792, DcOverloadAlarmsMask),
            ...
            acOverloadAlarmsMask: OptionalWritableAttribute(2048, AcOverloadAlarmsMask),
