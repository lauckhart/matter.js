...
/**
 * Standard ElectricalMeasurement cluster properties.
 */
export const ElectricalMeasurementMetadata = ClusterMetadata({ id: 0xb04, name: "ElectricalMeasurement", revision: 1 });
...
export type ElectricalMeasurementCluster<T extends TypeFromPartialBitSchema<typeof ElectricalMeasurementMetadata.features>> = 
    typeof ElectricalMeasurementMetadata
    & { supportedFeatures: T }
    & typeof BaseComponent;

export function ElectricalMeasurementCluster<T extends (keyof typeof ElectricalMeasurementMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...ElectricalMeasurementMetadata,
        supportedFeatures: BitFlags(ElectricalMeasurementMetadata.features, ...features),
        ...BaseComponent
    };
    
    return cluster as unknown as ElectricalMeasurementCluster<BitFlags<typeof ElectricalMeasurementMetadata.features, T>>;
};