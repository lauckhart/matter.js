...
export namespace ColorControlCluster {
    ...
    const Base = {
        attributes: {
            /**
             * The RemainingTime attribute holds the time remaining, in 1/10ths
             * of a second, until the currently active command will be complete.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.7.3
             */
            remainingTime: OptionalAttribute(2, TlvUInt16, { readAcl: AccessLevel.View }),

            /**
             * The DriftCompensation attribute indicates what mechanism, if
             * any, is in use for compensation for color/intensity drift over
             * time. It SHALL be one of the non-reserved values in Values of
             * the DriftCompensation Attribute.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.7.6
             */
            ...
            /**
             * The CompensationText attribute holds a textual indication of
             * what mechanism, if any, is in use to
             *
            ...
            /**
             * The NumberOfPrimaries attribute contains the number of color
             * primaries implemented on this device. A value of null SHALL
             * indicate that the number of primaries is unknown.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.8.1
             */
            numberOfPrimaries: FixedAttribute(16, TlvNullable(TlvUInt8), { readAcl: AccessLevel.View }),

            /**
             * The Primary1X attribute contains the normalized chromaticity
             * value x for this primary, as defined in the CIE xyY Color Space.
             *
            ...
            /**
             * The Primary1Y attribute contains the normalized chromaticity
             * value y for this primary, as defined in the CIE xyY Color Space.
             *
            ...
            /**
             * The Primary1intensity attribute contains a representation of the
             * maximum intensity of this primary as defined in the Dimming
             * Light Curve in the Ballast Configuration cluster (see Ballast
             * Configuration Cluster), normalized such that the primary with
             * the highest maximum intensity contains the value 0xfe.
             *
            ...
            /**
             * The WhitePointX attribute contains the normalized chromaticity
             * value x, as defined in the CIE xyY Color Space, of the current
            ...
            /**
             * The WhitePointY attribute contains the normalized chromaticity
             * value y, as defined in the CIE xyY Color Space, of the current
             * white point of the device.
             *
            ...
            /**
             * The ColorPointRX attribute contains the normalized chromaticity
             * value x, as defined in the CIE xyY Color Space, of the red color
             * point of the device.
             *
            ...
            /**
             * The ColorPointRY attribute contains the normalized chromaticity
             * value y, as defined in the CIE xyY Color Space, of the red color
             * point of the device.
             *
            ...
            /**
             * The ColorPointRIntensity attribute contains a representation of
             * the relative intensity of the red color point as defined in the
             * Dimming Light Curve in the Ballast Configuration cluster (see
             * Ballast Configuration Cluster), normalized such that the color
             * point with the highest relative intensity contains the value
             * 0xfe.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.10.5
             */
            colorPointRIntensity: OptionalWritableAttribute(52, TlvNullable(TlvUInt8), { readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.10
             */
            colorPointGIntensity: OptionalWritableAttribute(56, TlvNullable(TlvUInt8), { readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.10
             */
            colorPointBIntensity: OptionalWritableAttribute(60, TlvNullable(TlvUInt8), { readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage }),

            /**
             * The EnhancedColorMode attribute specifies which attributes are
             * currently determining the color of the device, as detailed in
             * Values of the EnhancedColorMode Attribute.
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.7.12
             */
            enhancedColorMode: Attribute(16385, TlvEnum<EnhancedColorMode>(), { persistent: true, default: 1, readAcl: AccessLevel.View }),

            /**
             * Bits 0-4 of the ColorCapabilities attribute SHALL have the same
             * values as the corresponding bits of the FeatureMap attribute.
             * All other bits in ColorCapabilities SHALL be 0.
             *
    ...
    const XY = {
        attributes: {
             ...
             * normalized chromaticity value x, as defined in the CIE xyY Color
             * Space. It is updated as fast as practical during commands that
             * change the color.
             *
            ...
            /**
             * The CurrentY attribute contains the current value of the
             * normalized chromaticity value y, as defined in the CIE xyY Color
             * Space. It is updated as fast as practical during commands that
             * change the color.
             *
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.11
             */
            moveToColor: Command(7, MoveToColorRequest, 7, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.12
             */
            moveColor: Command(8, MoveColorRequest, 8, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.13
             */
            stepColor: Command(9, StepColorRequest, 9, TlvNoResponse)
        }
    };
    ...
    const CT = {
        attributes: {
             ...
             * of the current value of the color temperature. The unit of
             * ColorTemperatureMireds is the mired (micro reciprocal degree),
             * AKA mirek (micro reciprocal kelvin). It is updated as fast as
            ...
            /**
             * The ColorTempPhysicalMinMireds attribute indicates the minimum
             * mired value supported by the hardware.
            ...
            /**
             * The ColorTempPhysicalMaxMireds attribute indicates the maximum
             * mired value supported by the hardware.
            ...
            /**
             * The CoupleColorTempToLevelMinMireds attribute specifies a lower
             * bound on the value of the ColorTemperatureMireds attribute for
             * the purposes of coupling the ColorTemperatureMireds attribute to
             * the CurrentLevel attribute when the CoupleColorTempToLevel bit
             * of the Options attribute of the Level Control cluster is equal
             * to 1. When coupling the ColorTemperatureMireds attribute to the
             * CurrentLevel attribute, this value SHALL correspond to a
             * CurrentLevel value of 0xfe (100%).
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.7.21
             */
            coupleColorTempToLevelMinMireds: Attribute(16397, TlvUInt16, { readAcl: AccessLevel.View }),

            /**
             * The StartUpColorTemperatureMireds attribute SHALL define the
             * desired startup color temperature value a lamp SHALL use when it
             * is supplied with power and this value SHALL be reflected in the
             * ColorTemperatureMireds attribute. In addition, the ColorMode and
             * EnhancedColorMode attributes SHALL be set to 0x02 (color
             * temperature). The values of the StartUpColorTemperatureMireds
             * attribute are listed in the table below,
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.7.22
             */
            startUpColorTemperatureMireds: WritableAttribute(16400, TlvNullable(TlvUInt16), { readAcl: AccessLevel.View, writeAcl: AccessLevel.Manage })
        },
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.14
             */
            moveToColorTemperature: Command(10, MoveToColorTemperatureRequest, 10, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.21
             */
            moveColorTemperature: Command(75, MoveColorTemperatureRequest, 75, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.22
             */
            stepColorTemperature: Command(76, StepColorTemperatureRequest, 76, TlvNoResponse)
        }
    };
    ...
    const EHUE = {
        attributes: {
             ...
             * steps along the CIE 1931 color triangle, and it provides 16-bits
             * precision.
             *
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.15
             */
            enhancedMoveToHue: Command(64, EnhancedMoveToHueRequest, 64, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.16
             */
            enhancedMoveHue: Command(65, EnhancedMoveHueRequest, 65, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.17
             */
            enhancedStepHue: Command(66, EnhancedStepHueRequest, 66, TlvNoResponse),
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.18
             */
            enhancedMoveToHueAndSaturation: Command(67, EnhancedMoveToHueAndSaturationRequest, 67, TlvNoResponse)
        }
    };
    ...
    const CL = {
        attributes: {
             ...
             * status of the color loop. If this attribute
             *
            ...
            /**
             * The ColorLoopDirection attribute specifies the current direction
             * of the color loop. If this attribute has the value 0, the
             * EnhancedCurrentHue attribute SHALL be decremented. If this
             * attribute has the value 1, the EnhancedCurrentHue attribute
             * SHALL be incremented. All other values (2 to 254) are reserved.
             *
            ...
            /**
             * The ColorLoopTime attribute specifies the number of seconds it
             * SHALL take to perform a full color loop, i.e., to cycle all
             * values of the EnhancedCurrentHue attribute (between 0 and
             * 0xfffe).
             *
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.7.15
             */
            colorLoopTime: Attribute(16388, TlvUInt16, { scene: true, persistent: true, default: 25, readAcl: AccessLevel.View }),

            /**
             * The ColorLoopStartEnhancedHue attribute specifies the value of
             * the EnhancedCurrentHue attribute from which the color loop SHALL
             * be started.
             *
            ...
            /**
             * The ColorLoopStoredEnhancedHue attribute specifies the value of
             * the EnhancedCurrentHue attribute before the color loop was
             * started. Once the color loop is complete, the EnhancedCurrentHue
        ...
        commands: {
             ...
             * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.2.11.19
             */
            colorLoopSet: Command(68, ColorLoopSetRequest, 68, TlvNoResponse)
        }
    };
