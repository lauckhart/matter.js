...
export namespace DiagnosticLogsCluster {
     ...
     * Diagnostic Logs
     *
     * The cluster provides commands for retrieving unstructured diagnostic
     * logs from a Node that may be used to aid in diagnostics.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `DiagnosticLogs.with()` and a list of
     * supported features.
     *
