...
/**
 * Standard BallastConfiguration cluster properties.
 *
 * @see {@link MatterApplicationClusterSpecificationV1_1} § 3.3
 */
export const BallastConfigurationMetadata = ClusterMetadata({ id: 0x301, name: "BallastConfiguration", revision: 1 });
...
export type BallastConfigurationCluster<T extends TypeFromPartialBitSchema<typeof BallastConfigurationMetadata.features>> = 
    typeof BallastConfigurationMetadata
    & { supportedFeatures: T }
    & typeof BaseComponent;

export function BallastConfigurationCluster<T extends (keyof typeof BallastConfigurationMetadata.features)[]>(...features: [ ...T ]) {
    const cluster = {
        ...BallastConfigurationMetadata,
        supportedFeatures: BitFlags(BallastConfigurationMetadata.features, ...features),
        ...BaseComponent
    };
    
    return cluster as unknown as BallastConfigurationCluster<BitFlags<typeof BallastConfigurationMetadata.features, T>>;
};