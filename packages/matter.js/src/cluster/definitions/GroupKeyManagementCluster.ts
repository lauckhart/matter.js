...
import { Cluster, WritableAttribute, AccessLevel, FabricScopedAttribute, FixedAttribute, Command, TlvNoResponse } from "../../cluster/Cluster.js";
...
export namespace GroupKeyManagementCluster {
     ...
     *
     * The Group Key Management Cluster is the mechanism by which group keys
     * are managed.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `GroupKeyManagement.with()` and a list of
     * supported features.
     *
