...
export namespace KeypadInputCluster {
     ...
     * Keypad Input
     *
     * This cluster provides an interface for controlling a device like a TV
     * using action commands such as UP, DOWN, and SELECT.
     *
     * This cluster definition includes all elements an implementation may
     * support.  For type safety, use `KeypadInput.with()` and a list of
     * supported features.
     *
