...
export namespace Scenes {
    ...
    export interface Client {
        ...
        onSceneCountChange(value: number, previous: number): void;
        onCurrentSceneChange(value: number, previous: number): void;
        onCurrentGroupChange(value: number, previous: number): void;
        onSceneValidChange(value: boolean, previous: boolean): void;
        onNameSupportChange(value: number, previous: number): void;
        onLastConfiguredByChange(value: any | undefined, previous: any | undefined): void;
    }
