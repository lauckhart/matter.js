...
import { Power, LightPower } from "../../cluster/interface/index.js";

export class CastingVideoPlayer extends AutoDevice.implement(DeviceTypes.CASTING_VIDEO_PLAYER, Power) {
