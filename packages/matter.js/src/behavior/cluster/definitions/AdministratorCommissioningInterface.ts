...
export namespace AdministratorCommissioningInterface {
     ...
     * On completion, the command shall return a cluster specific status code from the enumeration below reflecting
     * success or reasons for failure of the operation. The new Administrator shall discover the Node on the IP network
     ...
     * node supports the Basic Commissioning Method. The Basic Commissioning Method specifies a window of time during
     * which an already commissioned Node accepts PASE sessions. The current Administrator shall specify a timeout
     * value for the duration of OBCW.
     *
     * If a commissioning window is already currently open, this command shall fail with a cluster specific status code
     * of Busy.
     *
     ...
     * Node. This is known as Open Basic Commissioning Window (OBCW). This timeout shall follow guidance as specified
     * in Announcement Duration.
     *
