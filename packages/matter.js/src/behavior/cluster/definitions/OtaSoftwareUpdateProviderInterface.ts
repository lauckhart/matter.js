...
export namespace OtaSoftwareUpdateProviderInterface {
    ...
    /**
     * This field shall contain the UpdateToken as specified in Section 11.19.3.6.1, “UpdateToken usage”. This field
     ...
     */
    export type ApplyUpdateRequestRequest = TypeFromSchema<typeof OtaSoftwareUpdateProvider.TlvApplyUpdateRequestRequest>;
     ...
     * never come back (e.g. device removed from Fabric altogether, or a critical malfunction), an OTA Provider shall
     * NOT expect every OTA Requestor to invoke this command for correct operation of the OTA Provider.
     *
    ...
    export interface Base {
         ...
         * @see {@link MatterCoreSpecificationV1_1} § 11.19.6.5.18
         */
        applyUpdateRequest(request: ApplyUpdateRequestRequest): MaybePromise<ApplyUpdateResponse>;
