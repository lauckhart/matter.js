...
export namespace ClusterInterface {
    ...
    export interface Empty { components: [] };
    ...
    export type InterfaceOf<B> =
        B extends { Interface: infer I extends ClusterInterface }
            ? I
            : ClusterInterface;
    ...
    export type InterfaceMethodsOf<I extends ClusterInterface, S extends ClusterComposer.FeatureFlags> =
        ClusterInterface extends I
            ?
                {}
            :
                AppliedMethodsOf<
                    ApplicableComponents<I["components"], S>
                >;
    ...
    export type ApplicableComponents<
        CA extends Component[],
