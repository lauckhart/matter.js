...
export namespace AudioOutputInterface {
     ...
     *
     * Updates to the output name shall appear in the device’s settings menus. Name updates may automatically be sent
     * to the actual device to which the output connects.
     *
