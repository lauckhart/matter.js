...
export namespace GroupKeyManagementInterface {
     ...
     *
     * If the EpochKey1 field is not null, its associated EpochStartTime1 field shall contain a later epoch start time
     * than the epoch start time found in the EpochStartTime0 field. Otherwise this command shall fail with an
     ...
     *
     * If the EpochKey2 field is not null, its associated EpochStartTime2 field shall contain a later epoch start time
     * than the epoch start time found in the EpochStartTime1 field. Otherwise this command shall fail with an
     * INVALID_COMMAND status code sent back to the initiator.
     *
     ...
     * GroupKeySetID did not match an existing entry, a new Group Key Set associated with the accessing fabric shall be
     * created with the provided data. The Group Key Set shall be written to non-volatile storage.
     *
