...
export namespace GroupsInterface {
    ...
    /**
     * The GetGroupMembership command allows a client to inquire about the group membership of the server endpoint, in
     * a number of ways.
     *
     ...
     * endpoint, on condition that the endpoint is identifying itself. Identifying functionality is controlled using
     * the Identify cluster, (see Identify).
     *
