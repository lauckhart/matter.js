...
Matter.children.push({
    ...
    children: [
        { tag: "attribute", name: "MeasurementType", id: 0x0, type: "map32", conformance: "O" },
        ...
        { tag: "attribute", name: "NeutralCurrent", id: 0x303, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "TotalActivePower", id: 0x304, type: "int32", conformance: "O" },
        ...
        { tag: "attribute", name: "RmsExtremeOverVoltagePeriod", id: 0x514, type: "uint16", access: "RW", conformance: "O" },
        {
            tag: "attribute", name: "RmsExtremeUnderVoltagePeriod", id: 0x515, type: "uint16", access: "RW",
            conformance: "O"
        },
        { tag: "attribute", name: "RmsVoltageSagPeriod", id: 0x516, type: "uint16", access: "RW", conformance: "O" },
        { tag: "attribute", name: "RmsVoltageSwellPeriod", id: 0x517, type: "uint16", access: "RW", conformance: "O" },
        ...
        { tag: "attribute", name: "DcOverloadAlarmsMask", id: 0x700, type: "map8", access: "RW", conformance: "O" },
        ...
        { tag: "attribute", name: "AcOverloadAlarmsMask", id: 0x800, type: "map16", access: "RW", conformance: "O" },
        ...
        { tag: "attribute", name: "AverageRmsVoltageMeasurementPeriodPhaseB", id: 0x911, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "AverageRmsOverVoltageCounterPhaseB", id: 0x912, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "AverageRmsUnderVoltageCounterPhaseB", id: 0x913, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "RmsExtremeOverVoltagePeriodPhaseB", id: 0x914, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "RmsExtremeUnderVoltagePeriodPhaseB", id: 0x915, type: "uint16", conformance: "O" },
        ...
        { tag: "attribute", name: "AverageRmsVoltageMeasurementPeriodPhaseC", id: 0xa11, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "AverageRmsOverVoltageCounterPhaseC", id: 0xa12, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "AverageRmsUnderVoltageCounterPhaseC", id: 0xa13, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "RmsExtremeOverVoltagePeriodPhaseC", id: 0xa14, type: "uint16", conformance: "O" },
        { tag: "attribute", name: "RmsExtremeUnderVoltagePeriodPhaseC", id: 0xa15, type: "uint16", conformance: "O" },
