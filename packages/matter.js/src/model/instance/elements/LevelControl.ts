    ...
    children: [
        {
            ...
            access: "R V", conformance: "M", constraint: "MinLevel to MaxLevel", default: 0, quality: "X N S", type: "uint8",
...

        {
            ...
            access: "R V", conformance: "O", default: 0, type: "uint8",
...

        {
            ...
            access: "RW", conformance: "M", constraint: "MinLevel to MaxLevel", default: "null", quality: "X", type: "uint8",
...

        {
            ...
            access: "RW", conformance: "O", default: "null", quality: "X", type: "uint16",
...

        {
            ...
            access: "RW", conformance: "M", constraint: "desc", default: 0, type: "LevelControlOptions",
