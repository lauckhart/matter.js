...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { section: "1.8.4", document: "cluster", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "desc", default: NaN, quality: "FX",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "desc", default: NaN, quality: "SN",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "O", constraint: "desc", default: NaN, quality: "NX",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "DEPONOFF", constraint: "desc", default: NaN, quality: "NX",
        ...
        CommandElement({
            ...
            xref: { section: "1.8.6.1", document: "cluster", version: "1.1" }
        }),
        ...
        DatatypeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    access: "R", conformance: "M", constraint: "max 64", default: "MS", quality: "F",
                ...
                DatatypeElement({
                    ...
                    access: "R", conformance: "M", constraint: "", default: NaN, quality: "F",
