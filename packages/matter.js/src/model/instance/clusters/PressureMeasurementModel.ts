...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { section: "2.4.4", document: "cluster", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinMeasuredValue to MaxMeasuredValue", default: 0, quality: "XP",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "-32767 toMaxMeasuredValue-1", default: 0, quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinMeasuredValue+1 to 32767", default: 0, quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "EXT", constraint: "-32767 toMaxScaledValue-1", default: 0, quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "EXT", constraint: "MinScaledValue+1 to 32767", default: 0, quality: "X",
