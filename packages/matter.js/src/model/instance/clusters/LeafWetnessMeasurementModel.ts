...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "0 to MaxMeasuredValue-1", default: 0, quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinMeasuredValue+1 to 10000", default: 0, quality: "X",
