...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { section: "4.4.5", document: "cluster", version: "1.1" }
                }),
        ...
        AttributeElement({
            ...
            access: "R[W] VO", conformance: "M", constraint: "0 to 5", default: NaN, quality: "N",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "0 to 100", default: NaN,
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "SPD", constraint: "1 to 100", default: NaN, quality: "F",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "SPD", constraint: "0 to SpeedMax", default: NaN, quality: "P",
