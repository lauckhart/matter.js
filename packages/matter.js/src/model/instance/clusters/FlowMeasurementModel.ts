...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinMeasuredValue to MaxMeasuredValue", default: NaN, quality: "XP",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinMeasuredValue+1 to 65534", default: 0, quality: "X",
