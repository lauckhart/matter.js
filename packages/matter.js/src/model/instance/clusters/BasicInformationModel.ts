...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", default: NaN, quality: "F",
        ...
        AttributeElement({
            ...
            access: "RW VM", conformance: "O", default: {}, quality: "N",
        ...
        EventElement({
            ...
            xref: { section: "11.1.6.1", document: "core", version: "1.1" }
        }),
        ...
        EventElement({
            ...
            xref: { section: "11.1.6.2", document: "core", version: "1.1" }
        }),
        ...
        EventElement({
            ...
            xref: { section: "11.1.6.3", document: "core", version: "1.1" }
        }),
        ...
        EventElement({
            ...
            xref: { section: "11.1.6.4", document: "core", version: "1.1" }
        }),
