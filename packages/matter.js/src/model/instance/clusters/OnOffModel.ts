...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { section: "1.5.4", document: "cluster", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", default: {}, quality: "SN",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "LT", default: {},
        ...
        CommandElement({
            ...
            xref: { section: "1.5.7.1", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            access: "O", conformance: "M", direction: "request", response: "status",
            details: "This command does not have any data fields.",
            xref: { section: "1.5.7.2", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            access: "O", conformance: "M", direction: "request", response: "status",
            details: "This command does not have any data fields.",
            xref: { section: "1.5.7.3", document: "cluster", version: "1.1" }
        }),

        CommandElement({
            id: 0x0040, name: "OffWithEffect",
            access: "O", conformance: "LT", direction: "request", response: "status",
            details: "The OffWithEffect command allows devices to be turned off using enhanced ways of fading. The OffWithEffect command SHALL have the following data fields:",
            xref: { section: "1.5.7.4", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "1.5.7.5", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "1.5.7.6", document: "cluster", version: "1.1" }
        }),
