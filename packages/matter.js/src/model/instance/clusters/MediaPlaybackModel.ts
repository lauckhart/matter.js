...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { section: "6.10.2", document: "cluster", version: "1.1" }
                }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "AS", constraint: "desc", default: NaN, quality: "X",
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.1", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.2", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.3", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.4", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.5", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.6", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.7", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.8", document: "cluster", version: "1.1" }
        }),

        CommandElement({
            id: 0x0008, name: "SkipForward",
            access: "O", conformance: "O", direction: "request", response: "PlaybackResponse",
            details: "Upon receipt, this SHALL Skip forward in the media by the given number of milliseconds, using the data as follows:",
            xref: { section: "6.10.4.9", document: "cluster", version: "1.1" }
        }),

        CommandElement({
            id: 0x0009, name: "SkipBackward",
            access: "O", conformance: "O", direction: "request", response: "PlaybackResponse",
            details: "Upon receipt, this SHALL Skip backward in the media by the given number of milliseconds, using the data as follows:",
            xref: { section: "6.10.4.10", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.10.4.12", document: "cluster", version: "1.1" }
        }),

        CommandElement({
            id: 0x000b, name: "Seek",
            access: "O", conformance: "AS", direction: "request", response: "PlaybackResponse",
            details: "Upon receipt, this SHALL change the playback position in the media to the given position using data as follows:",
            xref: { section: "6.10.4.11", document: "cluster", version: "1.1" }
        }),
