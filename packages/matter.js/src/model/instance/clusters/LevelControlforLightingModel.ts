...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { section: "1.6.4", document: "cluster", version: "1.1" }
                }),
                ...
                DatatypeElement({
                    ...
                    xref: { section: "1.6.4.2", document: "cluster", version: "1.1" }
                }),
                ...
                DatatypeElement({
                    ...
                    xref: { section: "1.6.4.3", document: "cluster", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinLevel to MaxLevel", default: NaN, quality: "SNX",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "O", constraint: "!LT : 0 to MaxLevel LT : 1 to MaxLevel", default: NaN,
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "FQ", constraint: "MinFrequency to MaxFrequency", default: 0, quality: "PS",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "FQ", constraint: "MinFrequency to max", default: 0,
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "M", constraint: "MinLevel to MaxLevel", default: NaN, quality: "X",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "O", default: NaN, quality: "X",
        ...
        AttributeElement({
            ...
            access: "RW VM", conformance: "LT", constraint: "desc", default: NaN, quality: "XN",
        ...
        CommandElement({
            ...
            xref: { section: "1.6.6.1", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "1.6.6.2", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "1.6.6.3", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "1.6.6.4", document: "cluster", version: "1.1" }
        }),

        CommandElement({
            id: 0x0004, name: "MoveToLevelWithOnOff",
            access: "O", conformance: "M", direction: "request", response: "status",
            xref: { section: "1.6.6", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "1.6.6.5", document: "cluster", version: "1.1" }
        })
    ]
}))
