...
Matter.children.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[LF &PA_LF & ABS]", constraint: "InstalledOpenLimitLift to InstalledClosedLimitLift", default: NaN, quality: "XN",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[TL &PA_TL & ABS]", constraint: "InstalledOpenLimitTilt to InstalledClosedLimitTilt", default: NaN, quality: "XN",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "desc", default: NaN, quality: "N",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[LF & PA_LF]", constraint: "0 to 100", default: NaN, quality: "XNSP",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[TL & PA_TL]", constraint: "0 to 100", default: NaN, quality: "XNSP",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "LF & PA_LF", constraint: "0 to 10000", default: NaN, quality: "XSP",
            xref: { section: "5.3.5", document: "cluster", version: "1.1" }
        }),

        AttributeElement({
            id: 0x000c, name: "TargetPositionTiltPercentThs", base: "percent100ths",
            access: "R V", conformance: "TL & PA_TL", constraint: "0 to 10000", default: NaN, quality: "XSP",
            xref: { section: "5.3.5", document: "cluster", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "LF & PA_LF", constraint: "0 to 10000", default: NaN, quality: "XNP",
            xref: { section: "5.3.5", document: "cluster", version: "1.1" }
        }),

        AttributeElement({
            id: 0x000f, name: "CurrentPositionTiltPercentThs", base: "percent100ths",
            access: "R V", conformance: "TL & PA_TL", constraint: "0 to 10000", default: NaN, quality: "XNP",
            xref: { section: "5.3.5", document: "cluster", version: "1.1" }
        }),
