...
ChipMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R", conformance: "M", default: 254
        }),
        ...
        AttributeElement({
            ...
            access: "W", conformance: "M", default: 1
        }),

        AttributeElement({
            id: 0x0011, name: "MaxLevel", base: "uint8",
            access: "W", conformance: "M", default: 254
        }),
        ...
        AttributeElement({
            ...
            access: "W", conformance: "O", default: 255, quality: "X"
        }),
        ...
        AttributeElement({
            ...
            access: "W", conformance: "O", default: 16777215, quality: "X"
        }),
