...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "RW F A", conformance: "M", constraint: "desc",
        ...
        AttributeElement({
            ...
            access: "RW F A", conformance: "O", constraint: "desc",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "min 4", quality: "F",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "min 3", quality: "F",
