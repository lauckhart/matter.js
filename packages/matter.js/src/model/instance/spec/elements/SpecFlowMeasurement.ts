...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            id: 0x0000, name: "MeasuredValue", type: "uint16",
            access: "R V", conformance: "M", constraint: "MinMeasuredValue to MaxMeasuredValue", default: "null", quality: "X P",
        ...
        AttributeElement({
            id: 0x0001, name: "MinMeasuredValue", type: "uint16",
        ...
        AttributeElement({
            id: 0x0002, name: "MaxMeasuredValue", type: "uint16",
