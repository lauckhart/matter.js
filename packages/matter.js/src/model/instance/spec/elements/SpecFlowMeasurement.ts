...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", constraint: "MinMeasuredValue to MaxMeasuredValue", default: "null", quality: "X P",
        ...
        AttributeElement({
            ...
            access: "R V", constraint: "MinMeasuredValue1 to 65534", default: 0, quality: "X",
