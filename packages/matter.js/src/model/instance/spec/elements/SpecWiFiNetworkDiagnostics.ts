...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { document: "core", section: "11.14.4", version: "1.1" }
                }),
        ...
        EventElement({
            ...
            xref: { document: "core", section: "11.14.8.1", version: "1.1" }
        }),
        ...
        EventElement({
            ...
            xref: { document: "core", section: "11.14.8.2", version: "1.1" }
        }),
        ...
        EventElement({
            ...
            xref: { document: "core", section: "11.14.8.3", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "core", section: "11.14.7.1", version: "1.1" }
        }),
