...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            id: 0x0000, name: "OutputList", type: "list",
        ...
        AttributeElement({
            id: 0x0001, name: "CurrentOutput", type: "uint8",
        ...
        DatatypeElement({
            id: -1, name: "OutputInfoStruct", type: "struct",
            ...
            children: [
                ...
                DatatypeElement({
                    id: 0x0001, name: "OutputType", type: "OutputTypeEnum",
