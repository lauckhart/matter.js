...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { document: "core", section: "11.2.5", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            access: "RW F VM", constraint: "desc", default: "empty", quality: "N",
        ...
        AttributeElement({
            ...
            access: "R F", constraint: "desc", default: "empty",
        ...
        AttributeElement({
            ...
            xref: { document: "core", section: "11.2.7.3", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "core", section: "11.2.8.3", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "core", section: "11.2.8.4", version: "1.1" }
        }),

        CommandElement({
            id: 0x0004, name: "KeySetReadAllIndices",
            access: "F A", direction: "request", response: "KeySetReadAllIndicesResponse",
            ...
            xref: { document: "core", section: "11.2.8.5", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "core", section: "11.2.8.6", version: "1.1" }
        }),
