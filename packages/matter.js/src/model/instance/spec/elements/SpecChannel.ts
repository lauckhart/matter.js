...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { section: "6.6.2", document: "cluster", version: "1.1" }
                }),
        ...
        CommandElement({
            ...
            access: "O", conformance: "CL or LI", direction: "request", response: "ChangeChannelResponse",
            details: "Change the channel to the channel case-insensitive exact matching the value passed as an argument.",
            xref: { section: "6.6.4.1", document: "cluster", version: "1.1" }
        }),

        CommandElement({
            id: 0x0001, name: "ChangeChannelResponse",
            conformance: "CL or LI", direction: "response",
            details: "This command SHALL be generated in response to a ChangeChannel command. The data for this command SHALL be as follows:",
            xref: { section: "6.6.4.2", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.6.4.3", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.6.4.4", document: "cluster", version: "1.1" }
        }),
        ...
        DatatypeElement({
            ...
            children: [
                ...
                DatatypeElement({
                    ...
                    conformance: "O", constraint: "", default: "empty",
