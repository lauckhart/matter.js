...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "0, MinMeasuredValue to MaxMeasuredValue", value: "0", quality: "PX",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "1 to MaxMeasuredValue-1", value: "", quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinMeasuredValue+1 to 65534", value: "", quality: "X",
