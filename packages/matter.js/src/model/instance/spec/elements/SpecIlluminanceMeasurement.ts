...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "0, MinMeasuredValue to MaxMeasuredValue", quality: "X P",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "1 to MaxMeasuredValue1", quality: "X",
