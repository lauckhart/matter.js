    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    id: 0x0000, name: "LF",
                    conformance: "O.a1+", description: "Lift Control and behavior for lifting/sliding window coverings",
                    xref: { document: "cluster", section: "5.3.4", version: "1.1" }
                }),

                DatatypeElement({
                    id: 0x0001, name: "TL",
                    conformance: "O.a1+", description: "Tilt Control and behavior for tilting window coverings",
                    xref: { document: "cluster", section: "5.3.4", version: "1.1" }
                }),
