...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[LF & P, A, LF & ABS]", default: 0, quality: "F",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[TL & P, A, TL & ABS]", default: 0, quality: "F",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[LF & P, A, LF & ABS]", constraint: "InstalledOpenLimitLift to InstalledClosedLimitLift", default: "null", quality: "X N",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0004, name: "CurrentPositionTilt1", base: "uint16",
            access: "R V", conformance: "[TL & P, A, TL & ABS]", constraint: "InstalledOpenLimitTilt to InstalledClosedLimitTilt", default: "null", quality: "X N",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[LF & P, A, LF]", constraint: "0 to 100", default: "null", quality: "X N S P",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0009, name: "CurrentPositionTiltPercentage1", base: "percent",
            access: "R V", conformance: "[TL & P, A, TL]", constraint: "0 to 100", default: "null", quality: "X N S P",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),

        AttributeElement({
            id: 0x000a, name: "OperationalStatus", base: "map8",
            access: "R V", default: 0, quality: "P",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "LF & P, A, LF", constraint: "0 to 10000", default: "null", quality: "X S P",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),

        AttributeElement({
            id: 0x000c, name: "TargetPositionTiltPercent100Ths2", base: "percent100ths",
            access: "R V", conformance: "TL & P, A, TL", constraint: "0 to 10000", default: "null", quality: "X S P",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "LF & P, A, LF", constraint: "0 to 10000", default: "null", quality: "X N P",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),

        AttributeElement({
            id: 0x000f, name: "CurrentPositionTiltPercent100Ths1", base: "percent100ths",
            access: "R V", conformance: "TL & P, A, TL", constraint: "0 to 10000", default: "null", quality: "X N P",
            xref: { document: "cluster", section: "5.3.5", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0010, name: "InstalledOpenLimitLift", base: "uint16",
            access: "R V", conformance: "LF & P, A, LF & ABS", constraint: "0 to 65534", default: 0, quality: "N",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "LF & P, A, LF & ABS", constraint: "0 to 65534", default: 65534, quality: "N",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "TL & P, A, TL & ABS", constraint: "0 to 65534", default: 0, quality: "N",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "TL & P, A, TL & ABS", constraint: "0 to 65534", default: 65534, quality: "N",
        ...
        AttributeElement({
            ...
            access: "RW VM", default: 0, quality: "N",
