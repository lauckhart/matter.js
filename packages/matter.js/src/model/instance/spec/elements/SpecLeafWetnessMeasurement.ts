...
SpecMatter.children!.push(ClusterElement({
    id: 0x0407, name: "LeafWetnessMeasurement",
    classification: "application",
    children: [
        AttributeElement({
            id: 0xfffd, name: "ClusterRevision", base: "uint16",
            access: "R V", constraint: "min 1", default: 3, quality: "F"
        }),
        ...
        AttributeElement({
            ...
            access: "R V", constraint: "MinMeasuredValue to MaxMeasuredValue", default: 0, quality: "X P",
        ...
        AttributeElement({
            ...
            access: "R V", constraint: "0 to MaxMeasuredValue1", default: 0, quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", constraint: "MinMeasuredValue1 to 10000", default: 0, quality: "X",
