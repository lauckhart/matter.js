...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[WIRED]", quality: "F",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[BAT]", quality: "X C",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[BAT]", constraint: "0 to 200", quality: "X C",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[REPLC]", quality: "F",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[RECHG]", quality: "X C",
