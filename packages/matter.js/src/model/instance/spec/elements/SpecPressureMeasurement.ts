...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "EXT", constraint: "MinScaledValue to MaxScaledValue", quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "EXT", quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "EXT", constraint: "MinScaledValue1 to 32767", quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "[EXT]", constraint: "0 to 2048",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "EXT", constraint: "-127 to 127",
