...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            id: 0x0000, name: "MeasuredValue", type: "int16",
        ...
        AttributeElement({
            id: 0x0001, name: "MinMeasuredValue", type: "int16",
        ...
        AttributeElement({
            id: 0x0002, name: "MaxMeasuredValue", type: "int16",
        ...
        AttributeElement({
            id: 0x0003, name: "Tolerance", type: "uint16",
        ...
        AttributeElement({
            id: 0x0010, name: "ScaledValue", type: "int16",
        ...
        AttributeElement({
            id: 0x0011, name: "MinScaledValue", type: "int16",
        ...
        AttributeElement({
            id: 0x0012, name: "MaxScaledValue", type: "int16",
        ...
        AttributeElement({
            id: 0x0013, name: "ScaledTolerance", type: "uint16",
        ...
        AttributeElement({
            id: 0x0014, name: "Scale", type: "int8",
