...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "max 64", value: "MS", quality: "F",
            details: "This attribute describes the purpose of the server, in readable text.",
            xref: { section: "1.8.5.1", document: "cluster", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0001, name: "StandardNamespace", base: "enum16",
            access: "R V", conformance: "M", constraint: "desc", value: "null", quality: "FX",
            ...
            xref: { section: "1.8.5.2", document: "cluster", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0002, name: "SupportedModes", base: "list[ModeOptionStruct]",
            access: "R V", conformance: "M", constraint: "max 255", value: "MS", quality: "F",
            ...
            xref: { section: "1.8.5.3", document: "cluster", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0003, name: "CurrentMode", base: "uint8",
            access: "R V", conformance: "M", constraint: "desc", value: "MS", quality: "SN",
            details: "This attribute represents the current mode of the server.",
            xref: { section: "1.8.5.4", document: "cluster", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0004, name: "StartUpMode", base: "uint8",
            access: "RW VO", conformance: "O", constraint: "desc", value: "MS", quality: "NX",
            details: "The StartUpMode attribute value indicates the desired startup mode for the server when it is supplied with power.",
            xref: { section: "1.8.5.5", document: "cluster", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0005, name: "OnMode", base: "uint8",
            access: "RW VO", conformance: "DEPONOFF", constraint: "desc", value: "null", quality: "NX",
            ...
            xref: { section: "1.8.5.6", document: "cluster", version: "1.1" }
        }),

        DatatypeElement({
            id: -1, name: "ModeOptionStruct", base: "struct",
            details: "This is a struct representing a possible mode of the server.",
            xref: { section: "1.8.8.1", document: "cluster", version: "1.1" },
            children: [
                DatatypeElement({
                    id: 0x0000, name: "Label", base: "string",
                    access: "R", conformance: "M", constraint: "max 64", value: "MS", quality: "F",
                    ...
                    xref: { section: "1.8.8.1.1", document: "cluster", version: "1.1" }
                }),

                DatatypeElement({
                    id: 0x0001, name: "Mode", base: "uint8",
                    access: "R", conformance: "M", constraint: "", value: "MS", quality: "F",
                    ...
                    xref: { section: "1.8.8.1.2", document: "cluster", version: "1.1" }
                }),

                DatatypeElement({
                    id: 0x0002, name: "SemanticTags", base: "list[SemanticTagStruct]",
                    access: "R", conformance: "M", constraint: "max 64", value: "MS", quality: "F",
                    ...
                    xref: { section: "1.8.8.1.3", document: "cluster", version: "1.1" }
                })
            ]
        })
    ]
