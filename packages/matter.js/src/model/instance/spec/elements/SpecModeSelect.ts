...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "desc", quality: "X F",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "desc", quality: "N S",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "D, EPONOFF", constraint: "desc", quality: "X N",
        ...
        DatatypeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    access: "R", conformance: "M", constraint: "max 64", quality: "F",
