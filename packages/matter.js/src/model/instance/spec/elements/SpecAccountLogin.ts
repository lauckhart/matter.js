...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        CommandElement({
            ...
            access: "T A", conformance: "M", direction: "request", response: "GetSetupPinResponse",
            ...
            xref: { section: "6.2.4.1", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.2.4.2", document: "cluster", version: "1.1" }
        }),

        CommandElement({
            id: 0x0002, name: "Login",
            access: "T A", conformance: "M", direction: "request", response: "status",
            ...
            xref: { section: "6.2.4.3", document: "cluster", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { section: "6.2.4.4", document: "cluster", version: "1.1" }
        })
    ]
}));
