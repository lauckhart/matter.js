...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { document: "cluster", section: "1.3.4", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.3.6.1", version: "1.1" }
        }),

        CommandElement({
            id: 0x0000, name: "AddGroup",
            access: "F M", direction: "request", response: "AddGroupResponse",
            details: "The AddGroup command allows a client to add group membership in a particular group for the server endpoint.",
            xref: { document: "cluster", section: "1.3.7.1", version: "1.1" }
        }),

        CommandElement({
            id: 0x0001, name: "ViewGroup",
            access: "F O", direction: "request", response: "ViewGroupResponse",
            ...
            xref: { document: "cluster", section: "1.3.7.2", version: "1.1" }
        }),

        CommandElement({
            id: 0x0002, name: "GetGroupMembership",
            access: "F O", direction: "request", response: "GetGroupMembershipResponse",
            ...
            xref: { document: "cluster", section: "1.3.7.3", version: "1.1" }
        }),

        CommandElement({
            id: 0x0003, name: "RemoveGroup",
            access: "F M", direction: "request", response: "RemoveGroupResponse",
            ...
            xref: { document: "cluster", section: "1.3.7.4", version: "1.1" }
        }),

        CommandElement({
            id: 0x0004, name: "RemoveAllGroups",
            access: "F M", direction: "request", response: "status",
            ...
            xref: { document: "cluster", section: "1.3.7.5", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.3.7.6", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.3.7.7", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.3.7.8", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.3.7.9", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.3.7.10", version: "1.1" }
        })
    ]
}));
