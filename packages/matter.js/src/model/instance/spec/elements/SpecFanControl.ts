...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "M", constraint: "0 to 6", quality: "N",
        ...
        AttributeElement({
            ...
            access: "R[W] VO", conformance: "M", constraint: "0 to 5", quality: "N",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "M", constraint: "0 to 100", quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "0 to 100",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "SPD", constraint: "0 to SpeedMax", quality: "X",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "SPD", constraint: "0 to SpeedMax", quality: "P",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "RCK", constraint: "desc", quality: "F",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "RCK", constraint: "desc", quality: "P",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "WND", constraint: "desc", quality: "F",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "WND", constraint: "desc", quality: "P",
