...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "RW VM", conformance: "M", value: "null", quality: "X N",
            ...
            xref: { section: "11.4.6.1", document: "core", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0001, name: "ActiveCalendarType", base: "CalendarTypeEnum",
            access: "RW VM", conformance: "CALFMT", value: "null", quality: "X N",
            ...
            xref: { section: "11.4.6.2", document: "core", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0002, name: "SupportedCalendarTypes", base: "list[CalendarTypeEnum]",
            access: "R V", conformance: "CALFMT", constraint: "desc", value: "N/A", quality: "F",
            ...
            xref: { section: "11.4.6.3", document: "core", version: "1.1" }
        }),
