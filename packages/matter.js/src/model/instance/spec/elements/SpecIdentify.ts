...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    details: "This feature supports a unicast, groupcast or multicast query of the " +
                             "cluster state, with a response back to query initiator, if the " +
                             "identification state is active. This feature is supported for " +
                             "underlying stacks that support a response to a multicast or groupcast " +
                             "command",
                    xref: { document: "cluster", section: "1.2.4.1", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.2.5.1", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.2.5.2", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.2.6.1", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.2.6.2", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.2.6.3", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.2.6.4", version: "1.1" }
        })
    ]
}));
