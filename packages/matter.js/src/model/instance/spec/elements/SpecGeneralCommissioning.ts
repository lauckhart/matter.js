...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            id: 0x0002, name: "RegulatoryConfig", type: "RegulatoryLocationTypeEnum",
        ...
        AttributeElement({
            id: 0x0003, name: "LocationCapability", type: "RegulatoryLocationTypeEnum",
        ...
        DatatypeElement({
            id: -1, name: "CommissioningErrorEnum", type: "enum8",
