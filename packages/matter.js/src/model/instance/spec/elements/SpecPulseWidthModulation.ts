...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinLevel to MaxLevel", default: "null", quality: "SNX",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "O", constraint: "!LT : 0 to MaxLevel LT : 1 to MaxLevel", default: "!LT:0LT:1",
        ...
        AttributeElement({
            ...
            access: "RW VM", conformance: "LT", constraint: "desc", default: "MS", quality: "XN",
