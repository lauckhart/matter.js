...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    xref: { document: "cluster", section: "1.4.4", version: "1.1" }
                })
            ]
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.4.7.1", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.4.7.2", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.4.7.3", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.4.7.4", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.4.7.5", version: "1.1" }
        }),
        ...
        AttributeElement({
            ...
            xref: { document: "cluster", section: "1.4.7.6", version: "1.1" }
        }),

        CommandElement({
            id: 0x0000, name: "AddScene",
            access: "M", direction: "request", response: "AddSceneResponse",
            details: "The AddScene command SHALL have the following data fields:",
            xref: { document: "cluster", section: "1.4.9.2", version: "1.1" }
        }),

        CommandElement({
            id: 0x0001, name: "ViewScene",
            access: "O", direction: "request", response: "ViewSceneResponse",
            details: "The ViewScene command SHALL have the following data fields:",
            xref: { document: "cluster", section: "1.4.9.3", version: "1.1" }
        }),

        CommandElement({
            id: 0x0002, name: "RemoveScene",
            access: "M", direction: "request", response: "RemoveSceneResponse",
            details: "The RemoveScene command SHALL have the following data fields:",
            xref: { document: "cluster", section: "1.4.9.4", version: "1.1" }
        }),

        CommandElement({
            id: 0x0003, name: "RemoveAllScenes",
            access: "M", direction: "request", response: "RemoveAllScenesResponse",
            details: "The RemoveAllScenes command SHALL have the following data fields:",
            xref: { document: "cluster", section: "1.4.9.5", version: "1.1" }
        }),

        CommandElement({
            id: 0x0004, name: "StoreScene",
            access: "M", direction: "request", response: "StoreSceneResponse",
            details: "The StoreScene command SHALL have the following data fields:",
            xref: { document: "cluster", section: "1.4.9.6", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.7", version: "1.1" }
        }),

        CommandElement({
            id: 0x0006, name: "GetSceneMembership",
            access: "O", direction: "request", response: "GetSceneMembershipResponse",
            ...
            xref: { document: "cluster", section: "1.4.9.8", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.9", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.10", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.11", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.12", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.13", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.14", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.15", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.16", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.17", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.18", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.19", version: "1.1" }
        }),
        ...
        CommandElement({
            ...
            xref: { document: "cluster", section: "1.4.9.20", version: "1.1" }
        }),
        ...
        DatatypeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    access: "RW", conformance: "M, !Z", default: "",
                    ...
                    xref: { document: "cluster", section: "1.4.6.1.1", version: "1.1" }
                }),
                ...
                DatatypeElement({
                    ...
                    xref: { document: "cluster", section: "1.4.6.1.2", version: "1.1" }
                })
            ]
        })
    ]
