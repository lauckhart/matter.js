...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            children: [
                DatatypeElement({
                    ...
                    description: "Dependency with the On/Off cluster", value: "1",
                    xref: { document: "cluster", section: "1.6.4", version: "1.1" }
                }),

                DatatypeElement({
                    id: 0x0001, name: "LIGHTING",
                    description: "Behavior that supports lighting applications", value: "0",
                ...
                DatatypeElement({
                    ...
                    description: "Supports frequency attributes and behavior. The Pulse Width Modulation cluster was created for frequency control.", value: "0",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "M", constraint: "MinLevel to MaxLevel", quality: "X N S",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "O", constraint: "MinLevel to 254",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "FQ", constraint: "MinFrequency to MaxFrequency", quality: "S P",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "FQ", constraint: "0 to MaxFrequency",
        ...
        AttributeElement({
            ...
            access: "R V", conformance: "FQ", constraint: "min MinFrequency",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "M", constraint: "MinLevel to MaxLevel", quality: "X",
        ...
        AttributeElement({
            ...
            access: "RW VO", conformance: "O", quality: "X",
