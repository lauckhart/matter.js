...
SpecMatter.children!.push(ClusterElement({
    ...
    children: [
        ...
        AttributeElement({
            ...
            access: "RW VM", constraint: "max 35", default: "MS", quality: "N",
            ...
            xref: { document: "core", section: "11.3.4.1", version: "1.1" }
        }),

        AttributeElement({
            id: 0x0001, name: "SupportedLocales", base: "list",
            access: "R V", constraint: "max 32[max 35]", default: "MS", quality: "F",
