...
export const OnOffSensorRequirements = {
     ...
     */
    server: { mandatory: { Descriptor: DescriptorServer.set({ deviceTypeList: [{ deviceType: 2128, revision: 2 }] }) } },
...
export const OnOffSensorDeviceDefinition = MutableEndpoint({
    ...
    behaviors: SupportedBehaviors(OnOffSensorRequirements.server.mandatory.Descriptor)
});
