...
import { captureLogs } from "../logging.js";
...
describe("ClusterServer structure", () => {
    describe("correct attribute servers are used and exposed", () => {
        it("FixedAttribute has get but no set", async () => {
            ...
            expect(basic.attributes.softwareVersion instanceof FixedAttributeServer).toBeTruthy();
            ...
            expect(basic2?.attributes.softwareVersion instanceof FixedAttributeServer).toBeTruthy();
        ...
        it("Normal Attribute has set and get", async () => {
            ...
            expect(basic.attributes.nodeLabel instanceof AttributeServer).toBeTruthy();
        ...
        it("Optional existing fixed attribute, hast also get and no set, but potentially undefined", async () => {
            ...
            expect(basic.attributes.manufacturingDate instanceof FixedAttributeServer).toBeTruthy();
            // guard needed because as per types optional are potentially undefined
            ...
            expect(basic2?.attributes.manufacturingDate instanceof FixedAttributeServer).toBeTruthy();
            // guard needed because as per types optional are potentially undefined
        ...
        it("Fabric scoped attribute servers call fabric methods", () => {
            ...
            const fabric = {
                ...
                setScopedClusterDataValue<T>(cluster: Cluster<any, any, any, any, any>, clusterDataKey: string, value: T) {
                    ...
                    expect(value).toEqual({ value: [{}], version: 1 });
                }
            } as Fabric;

            expect(binding.attributes.binding.getLocal(fabric)).toEqual([])
