...
export interface TemperatureMeasurement extends ClusterNamespaceTyping { Attributes: TemperatureMeasurement.Attributes & { Components: TemperatureMeasurement.Attributes.Components } }
