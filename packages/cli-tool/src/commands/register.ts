...
Command({
    usage: "NAME URL",
    description:
        "Register a remote Matter node.  Creates a directory under the storage root with a CLI config file pointing" +
        " to the given WebSocket URL.  The node appears in the CLI namespace and connects lazily on first access.",
    positionalArgs: [
