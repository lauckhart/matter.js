...
export class EventServer<T = any, S extends Storage = any> {
    ...
    protected eventManager?: OccurrenceManager;
    #readAcl: AccessLevel | undefined;
    ...
    triggerEvent(data: T) {
        ...
        if (this.eventManager === undefined) {
            ...
            const finalEvent = this.eventManager.add(occurrence);
    ...
    get(
        ...
        if (this.eventManager === undefined) {
            throw new InternalError("EventServer not bound to EventManager");
        }
        if (this.endpoint === undefined) {
            throw new InternalError("EventServer not bound to Endpoint");
        }

        return this.eventManager.query(
