...
export const NetworkCommissioning = Cluster(
    ...
    Attribute(
        ...
        Field({ name: "WI", conformance: "O.a", constraint: "0" }),
        Field({ name: "TH", conformance: "O.a", constraint: "1" }),
        Field({ name: "ET", conformance: "O.a", constraint: "2" })
    ),
    ...
    Attribute({
        ...
        access: "R V", conformance: "WI | TH", constraint: "all", quality: "F"
    }),
    Attribute({
    ...
    Command(
        ...
        Field(
            { id: 0x2, name: "WiFiScanResults", type: "list", conformance: "WI", constraint: "all" },
            Field({ name: "entry", type: "WiFiInterfaceScanResultStruct" })
        ),
        Field(
            { id: 0x3, name: "ThreadScanResults", type: "list", conformance: "TH", constraint: "all" },
    ...
    Command(
        ...
        Field({ id: 0x0, name: "NetworkId", type: "octstr", conformance: "M", constraint: "1 to 32" }),
        Field({ id: 0x1, name: "NetworkIndex", type: "uint8", conformance: "M", constraint: "all" }),
        Field({ id: 0x2, name: "Breadcrumb", type: "uint64", conformance: "O" })
    ),
