...
export const CastingVideoPlayerDt = DeviceType(
    { id: 0x23, name: "CastingVideoPlayer", classification: "simple" },
    Requirement(
    ...
    Requirement({ id: 0x50a, name: "ContentLauncher", conformance: "M", element: "serverCluster" }),
    Requirement({ id: 0x50b, name: "AudioOutput", conformance: "O", element: "serverCluster" }),
    Requirement(
        { id: 0x50c, name: "ApplicationLauncher", conformance: "ContentAppPlatform", element: "serverCluster" },
