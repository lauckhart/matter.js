...
export const RvcCleanMode = Cluster(
    { id: 0x55, name: "RvcCleanMode", type: "ModeBase" },
    ...
    Datatype({ name: "ModeChangeStatus", type: "enum8" }, Field({ id: 0x40, name: "CleaningInProgress" })),
    ...
    Datatype(
        ...
        Field({ id: 0x4000, name: "DeepClean" }),
        Field({ id: 0x4001, name: "Vacuum" }),
        Field({ id: 0x4002, name: "Mop" })
    )
);
