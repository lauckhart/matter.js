...
export const Thermostat = Cluster(
    ...
    Attribute(
        ...
        Field({ name: "HEAT", conformance: "AUTO, O.a+", constraint: "0" }),
        Field({ name: "COOL", conformance: "AUTO, O.a+", constraint: "1" }),
        Field({ name: "OCC", conformance: "O", constraint: "2" }),
        Field({ name: "SCH", conformance: "O", constraint: "3" }),
        Field({ name: "SB", conformance: "O", constraint: "4" }),
        Field({ name: "AUTO", conformance: "O", constraint: "5" }),
        Field({ name: "LTNE", conformance: "O", constraint: "6" }),
        Field({ name: "MSCH", conformance: "O", constraint: "7" }),
        Field({ name: "PRES", conformance: "O", constraint: "8" })
    ),
    ...
    Attribute({
        ...
        access: "R V", conformance: "[HEAT]", constraint: "all", default: { type: "celsius", value: 7 },
        quality: "F"
    }),
    Attribute({
        id: 0x4, name: "AbsMaxHeatSetpointLimit", type: "temperature",
        access: "R V", conformance: "[HEAT]", constraint: "all", default: { type: "celsius", value: 30 },
        quality: "F"
    }),
    Attribute({
        id: 0x5, name: "AbsMinCoolSetpointLimit", type: "temperature",
        access: "R V", conformance: "[COOL]", constraint: "all", default: { type: "celsius", value: 16 },
        quality: "F"
    }),
    Attribute({
        id: 0x6, name: "AbsMaxCoolSetpointLimit", type: "temperature",
        access: "R V", conformance: "[COOL]", constraint: "all", default: { type: "celsius", value: 32 },
        quality: "F"
    }),
    Attribute({
    ...
    Attribute({
        ...
        access: "R[W] VM", conformance: "D", constraint: "all", default: 0, quality: "N"
    }),
    Attribute({
    ...
    Attribute({
        ...
        access: "RW VM", conformance: "[COOL]", constraint: "all",
    ...
    Attribute({ id: 0x1b, name: "ControlSequenceOfOperation", type: "ControlSequenceOfOperationEnum", access: "RW VM" }),
    Attribute({
        id: 0x1c, name: "SystemMode", type: "SystemModeEnum",
        access: "RW VM", conformance: "M", constraint: "all", default: 1, quality: "N"
    }),
    Attribute({
        id: 0x1e, name: "ThermostatRunningMode", type: "ThermostatRunningModeEnum",
        access: "R V", conformance: "[AUTO]", constraint: "all", default: 0
    }),
    Attribute({
        id: 0x20, name: "StartOfWeek", type: "StartOfWeekEnum",
        access: "R V", conformance: "SCH", constraint: "all", quality: "F"
    }),
    Attribute({
    ...
    Attribute({
        ...
        access: "RW VM", conformance: "O", constraint: "all", default: 0, quality: "P"
    }),
    Attribute({
        id: 0x29, name: "ThermostatRunningState", type: "RelayStateBitmap",
        access: "R V", conformance: "O", constraint: "all"
    }),
    Attribute({
    ...
    Attribute(
        {
            ...
            access: "R V", conformance: "PRES", constraint: "all", quality: "F"
        },
    ...
    Attribute(
        {
            ...
            access: "R V", conformance: "MSCH", constraint: "all", quality: "F"
        },
    ...
    Attribute(
        {
            ...
            access: "RW VM", conformance: "MSCH", constraint: "all", default: [], quality: "N T"
        },
    ...
    Command(
        ...
        Field({ id: 0x0, name: "Mode", type: "SetpointRaiseLowerModeEnum", conformance: "M", constraint: "all" }),
    ...
    Command(
        ...
        Field({ id: 0x1, name: "DayOfWeekForSequence", type: "ScheduleDayOfWeekBitmap", conformance: "M", constraint: "all" }),
        Field({ id: 0x2, name: "ModeForSequence", type: "ScheduleModeBitmap", conformance: "M", constraint: "all" }),
        Field(
    ...
    Command(
        ...
        Field({ id: 0x0, name: "DaysToReturn", type: "ScheduleDayOfWeekBitmap", conformance: "M", constraint: "all" }),
        Field({ id: 0x1, name: "ModeToReturn", type: "ScheduleModeBitmap", conformance: "M", constraint: "all" })
    ),
    ...
    Command(
        ...
        Field({ id: 0x1, name: "RelayStatus", type: "RelayStateBitmap", conformance: "M", constraint: "all" }),
    ...
    Datatype(
        ...
        Field({
            ...
            conformance: "COOL", constraint: "all", default: { type: "celsius", value: 26 }
        }),
        Field({
            id: 0x4, name: "HeatingSetpoint", type: "temperature",
            conformance: "HEAT", constraint: "all", default: { type: "celsius", value: 20 }
        }),
    ...
    Datatype(
        ...
        Field({ id: 0x1, name: "SystemMode", type: "SystemModeEnum", conformance: "M", constraint: "all" }),
    ...
    Datatype(
        ...
        Field({ id: 0x0, name: "DayOfWeek", type: "ScheduleDayOfWeekBitmap", conformance: "M", constraint: "all" }),
        ...
        Field({ id: 0x3, name: "SystemMode", type: "SystemModeEnum", conformance: "O", constraint: "all" }),
        Field({ id: 0x4, name: "CoolingSetpoint", type: "temperature", conformance: "[COOL]", constraint: "all" }),
        Field({ id: 0x5, name: "HeatingSetpoint", type: "temperature", conformance: "[HEAT]", constraint: "all" })
    ),

    Datatype(
        { name: "ScheduleTypeStruct", type: "struct" },
        Field({ id: 0x0, name: "SystemMode", type: "SystemModeEnum", conformance: "M", constraint: "all" }),
        Field({
        ...
        Field({
            ...
            conformance: "M", constraint: "all", default: 0
        })
    )
);
