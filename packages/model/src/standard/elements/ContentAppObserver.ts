...
export const ContentAppObserver = Cluster(
    {
        ...
        details: "This cluster provides an interface for sending targeted commands to an Observer of a Content App on " +
            ...
            "\n" +
            "1. The Content App Platform is able to easily determine that a binding is needed on the Content App " +
            "endpoint because it can recognize the Content App Observer cluster implemented by a client node." +
            "\n" +
