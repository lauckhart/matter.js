...
export const RefrigeratorAndTemperatureControlledCabinetMode = Cluster({
    ...
    children: [
        ...
        Attribute({
            ...
            children: [
                Field({ name: "entry", type: "RefrigeratorAndTemperatureControlledCabinetMode.ModeOptionStruct" })
            ]
        }),
        ...
        Datatype({
            ...
            children: [Field({
                ...
                children: [
                    Field({ name: "entry", type: "RefrigeratorAndTemperatureControlledCabinetMode.ModeTagStruct" })
                ]
            })]
        }),
        ...
        Datatype({
            ...
            children: [Field({ name: "Value", type: "RefrigeratorAndTemperatureControlledCabinetMode.ModeTag" })]
        })
    ]
})
