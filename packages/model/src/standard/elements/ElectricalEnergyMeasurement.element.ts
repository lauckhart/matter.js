...
export const ElectricalEnergyMeasurement = Cluster(
    ...
    Attribute(
        ...
        Field({ name: "IMPE", conformance: "O.a+", constraint: "0" }),
        Field({ name: "EXPE", conformance: "O.a+", constraint: "1" }),
        Field({ name: "CUME", conformance: "O.b+", constraint: "2" }),
        Field({ name: "PERE", conformance: "O.b+", constraint: "3" })
    ),
