...
export const PressureSensorDt = DeviceType(
    ...
    Requirement(
        ...
        Requirement({ name: "DeviceTypeList", element: "attribute", default: [ { deviceType: 773, revision: 2 } ] })
    ),
    Requirement({ name: "PressureMeasurement", id: 0x403, element: "serverCluster", conformance: "M" }),
