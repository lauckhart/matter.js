...
export const VideoRemoteControlDt = DeviceType(
    ...
    Requirement(
        ...
        Requirement({ name: "DeviceTypeList", element: "attribute", default: [ { deviceType: 42, revision: 2 } ] })
    ),
    ...
    Requirement({ name: "MediaPlayback", id: 0x506, element: "clientCluster", conformance: "M" }),
    ...
    Requirement({ name: "ContentLauncher", id: 0x50a, element: "clientCluster", conformance: "O" }),
