...
Resource.add({
    name: "CommissionerControl", tag: "cluster",
    classification: "node", pics: "CCTRL",
    ...
    children: [
        {
            name: "SupportedDeviceCategories", tag: "attribute",
        ...
        {
            name: "CommissioningRequestResult", tag: "event",
        ...
        {
            name: "RequestCommissioningApproval", tag: "command",
        ...
        {
            name: "CommissionNode", tag: "command",
        ...
        {
            name: "ReverseOpenCommissioningWindow", tag: "command",
        ...
        {
            name: "SupportedDeviceCategoryBitmap", tag: "datatype",
            xref: "core§11.26.4.1",
