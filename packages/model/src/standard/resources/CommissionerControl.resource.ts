...
Resource.add({
    tag: "cluster", name: "CommissionerControl",
    ...
    children: [
        {
            tag: "attribute", name: "SupportedDeviceCategories",
        ...
        {
            tag: "event", name: "CommissioningRequestResult",
        ...
        {
            tag: "command", name: "RequestCommissioningApproval",
        ...
        {
            tag: "command", name: "CommissionNode",
        ...
        {
            tag: "command", name: "ReverseOpenCommissioningWindow",
        ...
        {
            tag: "datatype", name: "SupportedDeviceCategoryBitmap",
            xref: "core§11.26.4.1",
