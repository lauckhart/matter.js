...
status.patch({
    ...
    children: [
        { description: "Operation was successful.", xref: "core§8.10.1" },
        { description: "Operation was not successful.", xref: "core§8.10.1" },
        { description: "Subscription ID is not active.", xref: "core§8.10.1" },
        {
        ...
        { description: "Attempt to write a read-only attribute.", xref: "core§8.10.1" },
        {
        ...
        { description: "Attempt to read a write-only attribute.", xref: "core§8.10.1" },
