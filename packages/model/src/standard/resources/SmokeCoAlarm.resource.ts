...
SmokeCoAlarm.patch({
    ...
    children: [
...

        {
            xref: "cluster§2.11.4",
            children: [
                { description: "SmokeAlarm", details: "Supports Smoke alarm" },
                { description: "CoAlarm", details: "Supports CO alarm" }
            ]
        },
        ...
        { details: "Indicates the contamination level of the smoke sensor.", xref: "cluster§2.11.6.11" },
        {
