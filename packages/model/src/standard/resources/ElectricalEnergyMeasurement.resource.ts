...
ElectricalEnergyMeasurement.patch({
    ...
    children: [
...

        {
            ...
            xref: "cluster§2.12.6.5"
        },

        { details: "Indicates when cumulative measurements were most recently zero.", xref: "cluster§2.12.6.6" },
