...
Resource.add({
    name: "ProxyDiscovery", tag: "cluster",
    classification: "node", pics: "PXDSC",
    ...
    children: [
        {
            name: "ProxyDiscoverRequest", tag: "command",
        ...
        {
            name: "ProxyDiscoverResponse", tag: "command",
            details: "This command is used during proxy discovery, as specified in Section 9.15.7, “Proxy Discovery & " +
                "Assignment Flow”.",
            ...
            children: [
                ...
                {
                    name: "NumHopsToSource", tag: "field",
                ...
                {
                    name: "AvailableCapacity", tag: "field",
