...
Resource.add({
    tag: "cluster", name: "ProxyDiscovery",
    ...
    children: [
        {
            tag: "command", name: "ProxyDiscoverRequest",
        ...
        {
            tag: "command", name: "ProxyDiscoverResponse",
            details: "This command is used during proxy discovery, as specified in Section 9.15.7, “Proxy Discovery & " +
                "Assignment Flow”.",
            ...
            children: [
                ...
                {
                    tag: "field", name: "NumHopsToSource",
                ...
                {
                    tag: "field", name: "AvailableCapacity",
