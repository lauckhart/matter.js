...
ThreadNetworkDiagnostics.patch({
    ...
    children: [
        ...
        { details: "Null when there is no dataset configured.", xref: "core§11.14.6.57" },
        { details: "Null when there is no dataset configured.", xref: "core§11.14.6.58" },
        { details: "Null when there is no dataset configured.", xref: "core§11.14.6.59" },
        {
...

        {
            ...
            children: [
                ...
                { details: "This field shall specify the RLOC16 of the neighboring Node.", xref: "core§11.14.5.4.3" },
                {
...

        {
            ...
            children: [
                ...
                { details: "This field shall be True if the Node has a Pan ID, else False.", xref: "core§11.14.5.7.8" },
                {
